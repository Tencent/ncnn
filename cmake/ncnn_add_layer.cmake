...
macro(ncnn_add_layer class)
    ...
    if((IOS AND CMAKE_OSX_ARCHITECTURES MATCHES "arm64") OR (APPLE AND CMAKE_OSX_ARCHITECTURES MATCHES "arm64") OR (CMAKE_SYSTEM_PROCESSOR MATCHES "^(arm64|aarch64)"))
        ...
        if(NCNN_ARM84FP16FML)
            ncnn_add_arch_opt_source(${class} asimdfhm "-march=armv8.4-a+fp16+dotprod+fp16fml")
        endif()
        if(NCNN_ARM86BF16)
            ncnn_add_arch_opt_source(${class} bf16 "-march=armv8.6-a+fp16+dotprod+fp16fml+bf16")
        endif()
        if(NCNN_ARM86I8MM)
            ncnn_add_arch_opt_source(${class} i8mm "-march=armv8.6-a+fp16+dotprod+fp16fml+i8mm")
        endif()
    endif()
