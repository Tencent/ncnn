    ...
    if(NCNN_TARGET_ARCH STREQUAL "x86")
        if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_FMA)
                ncnn_add_arch_opt_source(${class} fma "/arch:AVX /D__SSSE3__ /D__SSE4_1__ /D__FMA__ /D__F16C__")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_FMA4)
                ncnn_add_arch_opt_source(${class} fma4 "/arch:AVX /D__SSSE3__ /D__SSE4_1__ /D__XOP__ /D__FMA4__")
            endif()
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_AVX512VNNI AND NCNN_AVX512BF16)
                ncnn_add_arch_opt_source(${class} avx512vnni_avx512bf16 "/arch:AVX512 /D__SSSE3__ /D__SSE4_1__ /D__FMA__ /D__F16C__ /D__AVX512VNNI__ /D__AVX512BF16__")
            endif()
        ...
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND CMAKE_CXX_SIMULATE_ID MATCHES "MSVC" AND CMAKE_CXX_COMPILER_FRONTEND_VARIANT MATCHES "MSVC")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_FMA)
                ncnn_add_arch_opt_source(${class} fma "/arch:AVX -mfma -mf16c /D__SSSE3__ /D__SSE4_1__ /D__FMA__ /D__F16C__")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_FMA4)
                ncnn_add_arch_opt_source(${class} fma4 "/arch:AVX -mxop -mfma4 /D__SSSE3__ /D__SSE4_1__ /D__XOP__ /D__FMA4__")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_AVX)
                ncnn_add_arch_opt_layer(${class} avx "/arch:AVX /D__SSSE3__ /D__SSE4_1__")
            endif()
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_AVX512VNNI AND NCNN_AVX512BF16)
                ncnn_add_arch_opt_source(${class} avx512vnni_avx512bf16 "/arch:AVX512 -mavx512cd -mavx512bw -mavx512dq -mavx512vl -mfma -mf16c -mavx512vnni -mavx512bf16 /D__SSSE3__ /D__SSE4_1__ /D__FMA__ /D__F16C__ /D__AVX512VNNI__ /D__AVX512BF16__")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_AVX512FP16)
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_FMA)
                ncnn_add_arch_opt_source(${class} fma "-mavx -mfma -mf16c")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_FMA4)
                ncnn_add_arch_opt_source(${class} fma4 "-mavx -mxop -mfma4")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_AVX)
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_AVX512VNNI AND NCNN_AVX512BF16)
                ncnn_add_arch_opt_source(${class} avx512vnni_avx512bf16 "-mavx512f -mavx512cd -mavx512bw -mavx512dq -mavx512vl -mfma -mf16c -mavx512vnni -mavx512bf16")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_AVX512FP16)
    ...
    if(NCNN_TARGET_ARCH STREQUAL "arm" AND (CMAKE_SIZEOF_VOID_P EQUAL 8 OR NCNN_TARGET_ILP32))
        if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE)
                ncnn_add_arch_opt_layer(${class} sve "/arch:armv8.6 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE2)
                ncnn_add_arch_opt_source(${class} sve2 "/arch:armv8.6 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE2")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEBF16)
                ncnn_add_arch_opt_source(${class} svebf16 "/arch:armv8.6 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_BF16")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEI8MM)
                ncnn_add_arch_opt_source(${class} svei8mm "/arch:armv8.6 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_MATMUL_INT8")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEF32MM)
                ncnn_add_arch_opt_source(${class} svef32mm "/arch:armv8.6 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_MATMUL_FP32")
            endif()
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND CMAKE_CXX_SIMULATE_ID MATCHES "MSVC" AND CMAKE_CXX_COMPILER_FRONTEND_VARIANT MATCHES "MSVC")
            if(NCNN_VFPV4)
                ncnn_add_arch_opt_source(${class} vfpv4 " ")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE)
                ncnn_add_arch_opt_layer(${class} sve "/arch:armv8.6 -march=armv8.6-a+fp16+dotprod+sve /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE2)
                ncnn_add_arch_opt_source(${class} sve2 "/arch:armv8.6 -march=armv8.6-a+fp16+dotprod+sve2 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE2")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEBF16)
                ncnn_add_arch_opt_source(${class} svebf16 "/arch:armv8.6 -march=armv8.6-a+fp16+dotprod+sve+bf16 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_BF16")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEI8MM)
                ncnn_add_arch_opt_source(${class} svei8mm "/arch:armv8.6 -march=armv8.6-a+fp16+dotprod+sve+i8mm /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_MATMUL_INT8")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEF32MM)
                ncnn_add_arch_opt_source(${class} svef32mm "/arch:armv8.6 -march=armv8.6-a+fp16+dotprod+sve+f32mm /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_MATMUL_FP32")
            endif()
        else()
            if(NCNN_VFPV4)
                ncnn_add_arch_opt_source(${class} vfpv4 " ")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE)
                ncnn_add_arch_opt_layer(${class} sve "-march=armv8.6-a+fp16+dotprod+sve")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE2)
