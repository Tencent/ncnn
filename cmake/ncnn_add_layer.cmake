...
macro(ncnn_add_layer class)
    ...
    if(NCNN_TARGET_ARCH STREQUAL "arm" AND (CMAKE_SIZEOF_VOID_P EQUAL 8 OR NCNN_TARGET_ILP32))
        ...
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND CMAKE_CXX_SIMULATE_ID MATCHES "MSVC" AND CMAKE_CXX_COMPILER_FRONTEND_VARIANT MATCHES "MSVC")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE)
                ncnn_add_arch_opt_layer(${class} sve "/arch:armv8.6 -march=armv8.6-a+sve /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE2)
                ncnn_add_arch_opt_source(${class} sve2 "/arch:armv8.6 -march=armv8.6-a+sve2 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE2")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEBF16)
                ncnn_add_arch_opt_source(${class} svebf16 "/arch:armv8.6 -march=armv8.6-a+sve+bf16 /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_BF16")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEI8MM)
                ncnn_add_arch_opt_source(${class} svei8mm "/arch:armv8.6 -march=armv8.6-a+sve+i8mm /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_MATMUL_INT8")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVEF32MM)
                ncnn_add_arch_opt_source(${class} svef32mm "/arch:armv8.6 -march=armv8.6-a+sve+f32mm /D__ARM_FEATURE_FP16_VECTOR_ARITHMETIC /D__ARM_FEATURE_DOTPROD /D__ARM_FEATURE_FP16_FML /D__ARM_FEATURE_BF16_VECTOR_ARITHMETIC /D__ARM_FEATURE_MATMUL_INT8 /D__ARM_FEATURE_SVE /D__ARM_FEATURE_SVE_MATMUL_FP32")
            endif()
        else()
            if(NCNN_VFPV4)
                ncnn_add_arch_opt_source(${class} vfpv4 " ")
            ...
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE)
                ncnn_add_arch_opt_layer(${class} sve "-march=armv8.6-a+sve")
            endif()
            if(NCNN_RUNTIME_CPU AND NCNN_ARM86SVE2)
