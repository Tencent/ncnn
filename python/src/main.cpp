...
#if NCNN_STRING
#if _WIN32
    .def("load_param", [](Net& self, const std::wstring& path) { return self.load_param(path.c_str()); }, py::arg("protopath"))
#else
...
#endif // NCNN_STRING
#if _WIN32
    .def("load_param_bin", [](Net& self, const std::wstring& path) { return self.load_param_bin(path.c_str()); }, py::arg("protopath"))
    .def("load_model", [](Net& self, const std::wstring& path) { return self.load_model(path.c_str()); }, py::arg("modelpath"))
#else
