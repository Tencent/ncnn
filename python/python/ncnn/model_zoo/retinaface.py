...
class RetinaFace:
    ...
    def detect_stride32(self, ex):
        ...
        faceobjects32 = self.generate_proposals(anchors, feat_stride, score_blob, bbox_blob, landmark_blob, self.prob_threshold)
    ...
    def detect_stride8(self, ex):
        ...
        faceobjects8 = self.generate_proposals(anchors, feat_stride, score_blob, bbox_blob, landmark_blob, self.prob_threshold)
