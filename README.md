...
| iOS | [![Build Status](https://badges.herokuapp.com/travis/Tencent/ncnn?env=NAME=ios-iphoneos&label=build)](https://travis-ci.org/Tencent/ncnn) | [![Build Status](https://img.shields.io/github/workflow/status/Tencent/ncnn/ios-64bit-cpu)](https://github.com/Tencent/ncnn/actions?query=workflow%3Aios-64bit-cpu) | — | [![Build Status](https://img.shields.io/github/workflow/status/Tencent/ncnn/ios-64bit-gpu)](https://github.com/Tencent/ncnn/actions?query=workflow%3Aios-64bit-gpu) |
| iOS Simulator | [![Build Status](https://img.shields.io/github/workflow/status/Tencent/ncnn/ios-64bit-simulator)](https://github.com/Tencent/ncnn/actions?query=workflow%3Aios-64bit-simulator) | [![Build Status](https://img.shields.io/github/workflow/status/Tencent/ncnn/ios-64bit-simulator)](https://github.com/Tencent/ncnn/actions?query=workflow%3Aios-64bit-simulator) | — | — |
