...
template <typename T> std::string value_set(T data) {
  return std::to_string(data);
}

template <> std::string value_set<std::string>(std::string data) {
  return "\"" + data + "\"";
}

template <> std::string value_set<const char *>(const char *data) {
  return "\"" + std::string(data) + "\"";
}

template <typename T> std::string value_set(const std::vector<T> &data) {
  std::string text = "[ ";
...
template <typename T> T value_get(std::string text) {
  T result;
  std::stringstream ss;
  ss << text;
  ss >> result;
...
template <> std::string value_get<std::string>(std::string text) {
...
public:
  ...
  std::string operator[](std::string key) { return values[key]; }
  ...
  template <typename T> std::vector<T> get_list(std::string key) {
    std::string text = values[key];
    return value_get_list<T>(text);
  }

  template <typename T> void append(std::string key, T data) {
