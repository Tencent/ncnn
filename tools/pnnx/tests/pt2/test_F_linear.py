...
def test():
    ...
    program = torch.export.export(net, (x, y, z, w0, w1, b1))
    torch.export.save(program, "test_F_linear.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_F_linear.pt2", "inputshape=[1,16],[12,2,16],[1,3,12,16],[12,16],[32,12],[32]")
