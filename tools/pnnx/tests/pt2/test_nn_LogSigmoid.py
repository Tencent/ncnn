...
def test():
    ...
    torch.export.save(mod, "test_nn_LogSigmoid.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_nn_LogSigmoid.pt2 inputshape=[1,12],[1,12,64],[1,12,24,64],[1,12,24,32,64]")
