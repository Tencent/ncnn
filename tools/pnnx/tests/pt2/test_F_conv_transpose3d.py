...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, w0, w1, b1, y))
    torch.export.save(mod, "test_F_conv_transpose3d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_F_conv_transpose3d.pt2 inputshape=[1,12,10,12,14],[12,16,3,2,3],[16,8,5,4,5],[16],[1,6,4,5,6]")
