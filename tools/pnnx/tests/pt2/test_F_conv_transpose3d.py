...
def test():
    ...
    torch.export.save(program, "test_F_conv_transpose3d.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_F_conv_transpose3d.pt2", "inputshape=[1,12,10,12,14],[12,16,3,2,3],[16,8,5,4,5],[16],[1,6,4,5,6]")
