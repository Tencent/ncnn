...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, w))
    torch.export.save(mod, "test_nn_UpsamplingNearest2d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_nn_UpsamplingNearest2d.pt2 inputshape=[1,3,32,32],[1,8,86,86]")
