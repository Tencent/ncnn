...
def test():
    ...
    program = torch.export.export(net, (x, w))
    torch.export.save(program, "test_nn_UpsamplingNearest2d.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_nn_UpsamplingNearest2d.pt2", "inputshape=[1,3,32,32],[1,8,86,86]")
