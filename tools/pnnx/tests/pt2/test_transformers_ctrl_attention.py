...
def test():
    ...
    torch.export.save(mod, "test_transformers_ctrl_attention.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_transformers_ctrl_attention.pt2 inputshape=[3,16,192],[1,5,66]")
