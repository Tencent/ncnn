...
def test():
    ...
    torch.export.save(mod, "test_F_conv_transpose1d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_F_conv_transpose1d.pt2 inputshape=[1,12,22],[12,16,3],[16,8,5],[16],[1,6,5]")
