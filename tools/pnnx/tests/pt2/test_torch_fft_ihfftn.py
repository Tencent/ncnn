...
def test():
    ...
    torch.export.save(mod, "test_torch_fft_ihfftn.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_torch_fft_ihfftn.pt2 inputshape=[1,3,120,120],[1,100,2,120],[1,20,20]")
