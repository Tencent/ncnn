...
def test():
    ...
    torch.export.save(mod, "test_F_alpha_dropout.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_F_alpha_dropout.pt2 inputshape=[1,16],[12,2,16],[1,3,12,16],[1,5,7,9,11]")
