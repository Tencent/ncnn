...
def test():
    ...
    program = torch.export.export(net, (x, y, z, w0, b0, w1, b1, w2, b2))
    torch.export.save(program, "test_F_layer_norm.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_F_layer_norm.pt2", "inputshape=[1,12,24],[2,3,12,16],[1,10,12,16,24],[24],[24],[12,16],[12,16],[24],[24]")
