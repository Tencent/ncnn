...
def test():
    ...
    torch.export.save(mod, "test_transformers_chinese_clip_attention.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_transformers_chinese_clip_attention.pt2 inputshape=[2,11,192],[1,17,12]")
