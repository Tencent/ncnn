...
def test():
    ...
    torch.export.save(mod, "test_pnnx_fuse_conv2d_batchnorm2d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_pnnx_fuse_conv2d_batchnorm2d.pt2 inputshape=[1,12,64,64]")
