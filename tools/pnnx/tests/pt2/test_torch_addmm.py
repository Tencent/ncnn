...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (a0, a1, a2, b0, b1, b2, c1))
    torch.export.save(mod, "test_torch_addmm.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_torch_addmm.pt2 inputshape=[13,1],[13,16],[16,23],[7,33],[7,26],[26,33],[16,48]")
