...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, y, z, w0, w1, w2, x2))
    torch.export.save(mod, "test_F_rms_norm.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_F_rms_norm.pt2 inputshape=[1,12,24],[2,3,12,16],[1,10,12,16,24],[24],[12,16],[24],[3,22,66]")
