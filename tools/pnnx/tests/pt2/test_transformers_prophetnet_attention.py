...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, y, mask))
    torch.export.save(mod, "test_transformers_prophetnet_attention.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_transformers_prophetnet_attention.pt2 inputshape=[3,16,192],[2,5,66],[2,11,1,5]")
