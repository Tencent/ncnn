...
def test():
    ...
    torch.export.save(mod, "test_transformers_reformer_attention.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_transformers_reformer_attention.pt2 inputshape=[3,16,192],[2,5,66],[2,5]")
