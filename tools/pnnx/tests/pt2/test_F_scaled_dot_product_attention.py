...
def test():
    ...
    program = torch.export.export(net, (q, k, v, m))
    torch.export.save(program, "test_F_scaled_dot_product_attention.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_F_scaled_dot_product_attention.pt2", "inputshape=[3,8,128,64],[3,8,48,64],[3,8,48,77],[3,8,128,48]")
