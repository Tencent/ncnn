...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, mask))
    torch.export.save(mod, "test_transformers_mt5_attention.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_transformers_mt5_attention.pt2 inputshape=[3,16,192],[3,1,16,16]")
