...
def test():
    ...
    program = torch.export.export(net, (x, y, z, w, w0, w1, w2, w3))
    torch.export.save(program, "test_F_prelu.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_F_prelu.pt2", "inputshape=[1,16],[12,2,16],[1,3,12,16],[1,5,7,9,11],[16],[2],[3],[1]")
