...
def test():
    ...
    program = torch.export.export(net, (x, y, w))
    torch.export.save(program, "test_F_upsample_nearest.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_F_upsample_nearest.pt2", "inputshape=[1,12,24,64],[1,4,10,24,32],[1,8,86,86]")
