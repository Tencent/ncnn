...
def test():
    ...
    torch.export.save(mod, "test_pnnx_fuse_convtranspose1d_batchnorm1d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_pnnx_fuse_convtranspose1d_batchnorm1d.pt2 inputshape=[1,12,10]")
