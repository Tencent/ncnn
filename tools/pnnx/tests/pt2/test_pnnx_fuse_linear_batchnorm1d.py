...
def test():
    ...
    torch.export.save(mod, "test_pnnx_fuse_linear_batchnorm1d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_pnnx_fuse_linear_batchnorm1d.pt2 inputshape=[1,64],[12,64]")
