...
def test():
    ...
    torch.export.save(mod, "test_torch_view_as_real.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_torch_view_as_real.pt2 inputshape=[1,3,16]c64,[1,5,9,11]c64,[14,8,5,9,10]c64")
