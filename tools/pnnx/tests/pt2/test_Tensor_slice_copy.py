...
def test():
    ...
    torch.export.save(mod, "test_Tensor_slice_copy.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_Tensor_slice_copy.pt2 inputshape=[18,15,19,20],[15,19,20],[19,20],[120]")
