...
def test():
    ...
    torch.export.save(program, "test_nn_BatchNorm2d.pt2")

    from pnnxutil import run_pnnx
    run_pnnx("test_nn_BatchNorm2d.pt2", "inputshape=[1,32,12,64],[1,11,1,1]")

    import test_nn_BatchNorm2d_pnnx
    b0, b1 = test_nn_BatchNorm2d_pnnx.test_inference()

    return torch.allclose(a0, b0, 1e-3, 1e-3) and torch.allclose(a1, b1, 1e-3, 1e-3)
