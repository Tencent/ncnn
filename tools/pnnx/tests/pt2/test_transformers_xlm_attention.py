...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, kv, y, mask0, mask1))
    torch.export.save(mod, "test_transformers_xlm_attention.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_transformers_xlm_attention.pt2 inputshape=[3,16,192],[3,16,192],[2,5,66],[3,16],[2,5]")
