...
def test():
    ...
    torch.export.save(mod, "test_pnnx_fuse_convtranspose2d_batchnorm2d.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_pnnx_fuse_convtranspose2d_batchnorm2d.pt2 inputshape=[1,12,10,10]")
