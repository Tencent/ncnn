...
def test():
    ...
    torch.export.save(mod, "test_torchaudio_F_inverse_spectrogram.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_torchaudio_F_inverse_spectrogram.pt2 inputshape=[3,33,161]c64,[1,65,77]c64,[257,8]c64,[512,4]c64")
