...
def test():
    ...
    # export pt2
    mod = torch.export.export(net, (x, y, z, w, v))
    torch.export.save(mod, "test_torch_transpose.pt2")

    # pt2 to pnnx
    import os
    os.system(os.path.normpath("../../src/pnnx") + " test_torch_transpose.pt2 inputshape=[1,3,16],[1,5,9,11],[14,8,5,9,10],[2,3,5,7],[280]")
