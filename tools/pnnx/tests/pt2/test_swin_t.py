...
def test():
    ...
    torch.export.save(mod, "test_swin_t.pt2")

    # pt2 to pnnx
    import os
    if version.parse(torch.__version__) >= version.parse('2.0'):
        os.system(os.path.normpath("../../src/pnnx") + " test_swin_t.pt2")
    else:
        os.system(os.path.normpath("../../src/pnnx") + " test_swin_t.pt2 inputshape=[1,3,224,224]")
