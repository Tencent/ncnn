...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_pnnx_fuse_pixel_unshuffle.pt inputshape=[1,3,128,128]")
    ...
    pt2_ok = test_pnnx(net, (x,), ["[1,3,128,128]"], "test_pnnx_fuse_pixel_unshuffle")
