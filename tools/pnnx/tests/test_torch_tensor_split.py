...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_tensor_split.pt inputshape=[100],[3,16],[5,9,3],[6,13,6,22]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w), ["[100]", "[3,16]", "[5,9,3]", "[6,13,6,22]"], "test_torch_tensor_split")
