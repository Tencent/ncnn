...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_pnnx_fuse_conv1d_batchnorm1d.pt inputshape=[1,12,128]")
    ...
    pt2_ok = test_pnnx(net, (x,), ["[1,12,128]"], "test_pnnx_fuse_conv1d_batchnorm1d")
