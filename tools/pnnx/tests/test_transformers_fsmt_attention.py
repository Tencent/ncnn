...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_fsmt_attention.pt inputshape=[16,3,192],[5,1,66]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[16,3,192]", "[5,1,66]"], "test_transformers_fsmt_attention")
