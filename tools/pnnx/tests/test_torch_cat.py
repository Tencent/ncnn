...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_cat.pt inputshape=[1,3,16],[1,2,16],[1,5,9,11],[1,5,9,3]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w), ["[1,3,16]", "[1,2,16]", "[1,5,9,11]", "[1,5,9,3]"], "test_torch_cat")
