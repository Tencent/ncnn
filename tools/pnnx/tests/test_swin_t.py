...
def test():
    ...
    if version.parse(torch.__version__) >= version.parse('2.0'):
        os.system(os.path.join("..", "src", "pnnx") + " test_swin_t.pt")
    else:
        os.system(os.path.join("..", "src", "pnnx") + " test_swin_t.pt inputshape=[1,3,224,224]")
    ...
    pt2_ok = test_pnnx(net, (x,), ["[1,3,224,224]"], "test_swin_t")
