...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_stack.pt inputshape=[3,16],[3,16],[5,9,3],[5,9,3]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w), ["[3,16]", "[3,16]", "[5,9,3]", "[5,9,3]"], "test_torch_stack")
