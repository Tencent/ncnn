...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_xlm_attention.pt inputshape=[3,16,192],[3,16,192],[2,5,66],[3,16],[2,5]")
    ...
    pt2_ok = test_pnnx(net, (x, kv, y, mask0, mask1), ["[3,16,192]", "[3,16,192]", "[2,5,66]", "[3,16]", "[2,5]"], "test_transformers_xlm_attention")
