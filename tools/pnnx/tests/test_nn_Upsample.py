...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_Upsample.pt inputshape=[1,3,32],[1,3,32,32],[1,3,32,32,32],[1,8,12,12]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w), ["[1,3,32]", "[1,3,32,32]", "[1,3,32,32,32]", "[1,8,12,12]"], "test_nn_Upsample")
