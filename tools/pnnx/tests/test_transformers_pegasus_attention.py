...
def test():
    ...
    mod.save("test_transformers_pegasus_attention.pt")

    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_pegasus_attention.pt inputshape=[3,16,192],[1,5,66]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[3,16,192]", "[1,5,66]"], "test_transformers_pegasus_attention")
