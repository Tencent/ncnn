...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_F_avg_pool2d.pt inputshape=[1,12,128,127],[12,128,127]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,12,128,127]", "[12,128,127]"], "test_F_avg_pool2d")
