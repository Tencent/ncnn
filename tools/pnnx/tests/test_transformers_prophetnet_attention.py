...
def test():
    ...
    # export torchscript
    mod = torch.jit.trace(net, (x, y, z, mask, cross_mask))
    mod.save("test_transformers_prophetnet_attention.pt")

    # torchscript to pnnx
    import os
    os.system("../src/pnnx test_transformers_prophetnet_attention.pt inputshape=[3,16,192],[2,5,66],[2,7,66],[2,11,1,5],[2,11,1,7]")
