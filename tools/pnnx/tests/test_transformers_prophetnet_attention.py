...
def test():
    ...
    mod.save("test_transformers_prophetnet_attention.pt")

    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_prophetnet_attention.pt inputshape=[3,16,192],[2,5,66],[2,11,1,5]")
    ...
    pt2_ok = test_pnnx(net, (x, y, mask), ["[3,16,192]", "[2,5,66]", "[2,11,1,5]"], "test_transformers_prophetnet_attention")
