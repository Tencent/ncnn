...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_ChannelShuffle.pt inputshape=[1,64,6,8],[1,96,7,9]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,64,6,8]", "[1,96,7,9]"], "test_nn_ChannelShuffle")
