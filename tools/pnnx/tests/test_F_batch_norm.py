...
def test():
    ...
    a0, a1, a2 = net(x, y, z, m0, v0, w0, bias0, m1, v1, w1, bias1, m2, v2, w2, bias2)

    # export torchscript
    mod = torch.jit.trace(net, (x, y, z, m0, v0, w0, bias0, m1, v1, w1, bias1, m2, v2, w2, bias2))
    mod.save("test_F_batch_norm.pt")

    # torchscript to pnnx
    converted = torchscript_to_pnnx("test_F_batch_norm", "[1,16],[12,2,16],[1,3,12,16],[16],[16],[16],[16],[2],[2],[2],[2],[3],[3],[3],[3]")

    # pnnx inference
    b0, b1, b2 = converted(x, y, z, m0, v0, w0, bias0, m1, v1, w1, bias1, m2, v2, w2, bias2)
    ...
    inputs = (x, y, z, m0, v0, w0, bias0, m1, v1, w1, bias1, m2, v2, w2, bias2)
    converted = exported_program_to_pnnx(net, inputs, "test_F_batch_norm_pt2")
    c0, c1, c2 = converted(*inputs)
