...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_fft_ifft2.pt inputshape=[1,3,120,120],[1,100,2,120],[1,20,20]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[1,3,120,120]", "[1,100,2,120]", "[1,20,20]"], "test_torch_fft_ifft2")
