...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_Tensor_type_as.pt inputshape=[3,16],[1,13]i32,[8,5,9,10]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[3,16]", "[1,13]", "[8,5,9,10]"], "test_Tensor_type_as")
