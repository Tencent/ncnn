...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_PixelShuffle.pt inputshape=[1,128,6,8],[1,12,192,7,9]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,128,6,8]", "[1,12,192,7,9]"], "test_nn_PixelShuffle")
