...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_chunk.pt inputshape=[1,3,16],[1,5,9,11],[14,8,5,9,10]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[1,3,16]", "[1,5,9,11]", "[14,8,5,9,10]"], "test_torch_chunk")
