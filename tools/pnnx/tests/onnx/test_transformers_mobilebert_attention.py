...
def test():
    ...
    # export onnx
    torch.onnx.export(net, (x, y, v, r), "test_transformers_mobilebert_attention.onnx")

    # onnx to pnnx
    import os
    os.system("../../src/pnnx test_transformers_mobilebert_attention.onnx inputshape=[3,16,192],[1,5,22],[1,5,66],[1,5,22]")
