...
def test():
    ...
    # export onnx
    torch.onnx.export(net, (x, y), "test_transformers_camembert_attention.onnx")

    # onnx to pnnx
    import os
    os.system("../../src/pnnx test_transformers_camembert_attention.onnx inputshape=[3,16,192],[1,5,66]")
