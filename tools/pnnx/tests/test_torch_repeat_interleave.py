...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_repeat_interleave.pt inputshape=[3],[4,5],[3,7,8]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[3]", "[4,5]", "[3,7,8]"], "test_torch_repeat_interleave")
