...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_transpose.pt inputshape=[1,3,16],[1,5,9,11],[14,8,5,9,10],[2,3,5,7],[280]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w, v), ["[1,3,16]", "[1,5,9,11]", "[14,8,5,9,10]", "[2,3,5,7]", "[280]"], "test_torch_transpose")
