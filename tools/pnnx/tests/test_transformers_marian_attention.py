...
class Model(nn.Module):
    def __init__(self):
        ...
        self.attn0 = MarianAttention(embed_dim=192, num_heads=12)
        self.attn1 = MarianAttention(embed_dim=66, num_heads=6)
...
def test():
    ...
    mod.save("test_transformers_marian_attention.pt")

    # torchscript to pnnx
    import os
    os.system("../src/pnnx test_transformers_marian_attention.pt inputshape=[3,16,192],[1,5,66]")
