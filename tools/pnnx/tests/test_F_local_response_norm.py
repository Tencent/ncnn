...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_F_local_response_norm.pt inputshape=[1,12,24],[2,3,12,16],[1,10,12,16,24]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[1,12,24]", "[2,3,12,16]", "[1,10,12,16,24]"], "test_F_local_response_norm")
