...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_GELU.pt inputshape=[1,12],[1,12,64],[1,12,24,64],[1,12,24,32,64]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w), ["[1,12]", "[1,12,64]", "[1,12,24,64]", "[1,12,24,32,64]"], "test_nn_GELU")
