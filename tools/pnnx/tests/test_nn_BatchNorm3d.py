...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_BatchNorm3d.pt inputshape=[1,32,12,5,64],[1,11,3,1,1]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,32,12,5,64]", "[1,11,3,1,1]"], "test_nn_BatchNorm3d")
