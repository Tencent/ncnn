...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_mobilebert_attention.pt inputshape=[3,16,192],[1,5,22],[1,5,66],[1,5,22]")
    ...
    pt2_ok = test_pnnx(net, (x, y, v, r), ["[3,16,192]", "[1,5,22]", "[1,5,66]", "[1,5,22]"], "test_transformers_mobilebert_attention")
