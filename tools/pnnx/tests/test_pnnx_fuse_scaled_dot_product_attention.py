...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_pnnx_fuse_scaled_dot_product_attention.pt inputshape=[1,24,64],[1,24,64],[1,24,64]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[1,24,64]", "[1,24,64]", "[1,24,64]"], "test_pnnx_fuse_scaled_dot_product_attention")
