...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_chinese_clip_attention.pt inputshape=[2,11,192],[1,17,12]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[2,11,192]", "[1,17,12]"], "test_transformers_chinese_clip_attention")
