...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_torch_bitwise_right_shift.pt inputshape=[3,16]i32,[3,16]i32")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[3,16]", "[3,16]"], "test_torch_bitwise_right_shift")
