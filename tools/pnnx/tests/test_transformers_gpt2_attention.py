...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_gpt2_attention.pt inputshape=[3,16,192],[3,8,16,16]")
    ...
    pt2_ok = test_pnnx(net, (x, mask0), ["[3,16,192]", "[3,8,16,16]"], "test_transformers_gpt2_attention")
