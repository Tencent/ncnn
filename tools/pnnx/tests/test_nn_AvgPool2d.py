...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_AvgPool2d.pt inputshape=[1,12,128,128],[12,128,128]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,12,128,128]", "[12,128,128]"], "test_nn_AvgPool2d")
