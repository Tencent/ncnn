...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_F_max_pool3d.pt inputshape=[1,12,96,128,128],[12,96,128,128]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,12,96,128,128]", "[12,96,128,128]"], "test_F_max_pool3d")
