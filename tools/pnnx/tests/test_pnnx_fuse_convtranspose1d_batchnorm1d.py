...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_pnnx_fuse_convtranspose1d_batchnorm1d.pt inputshape=[1,12,10]")
    ...
    pt2_ok = test_pnnx(net, (x,), ["[1,12,10]"], "test_pnnx_fuse_convtranspose1d_batchnorm1d")
