...
class Model(nn.Module):
    ...
    def forward(self, x, q):
        ...
        q = F.max_pool3d(q, kernel_size=3)
        q = F.max_pool3d(q, kernel_size=(2,3,3), stride=1, padding=1, dilation=(1,1,1), return_indices=False, ceil_mode=False)
        return x, y, q
...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_F_max_pool3d.pt inputshape=[1,12,96,128,128],[2,3,8,10,12]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, q), ["[1,12,96,128,128]", "[2,3,8,10,12]"], "test_F_max_pool3d")
