...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_nn_ReplicationPad2d.pt inputshape=[1,12,13,13],[2,12,13,13]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y), ["[1,12,13,13]", "[2,12,13,13]"], "test_nn_ReplicationPad2d")
