...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_nn_UpsamplingBilinear2d.pt inputshape=[1,3,32,32],[2,3,8,8]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y), ["[1,3,32,32]", "[2,3,8,8]"], "test_nn_UpsamplingBilinear2d")
