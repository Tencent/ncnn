...
class Model(nn.Module):
    ...
    def forward(self, x, y, w, q):
        ...
        q = F.layer_norm(q, (24,), self.w3, self.b3)
...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_F_layer_norm.pt inputshape=[1,12,24],[1,3,12,16],[1,2,3,12,16],[2,12,24]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y, w, q), ["[1,12,24]", "[1,3,12,16]", "[1,2,3,12,16]", "[2,12,24]"], "test_F_layer_norm")
