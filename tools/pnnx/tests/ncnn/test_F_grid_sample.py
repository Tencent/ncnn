...
class Model(nn.Module):
    ...
    def forward(self, x, xg1, xg2, xgp1, xgp2, y, yg1, yg2, ygp1, ygp2, q, qg):
        # norm to -1 ~ 1
        xg1 = xg1 * 2 - 1
        xg2 = xg2 * 2 - 1
        yg1 = yg1 * 2 - 1
        ...
        q = F.grid_sample(q, qg, mode='bilinear', padding_mode='zeros', align_corners=False)
        return x0, y0, x1, y1, q
...
def test():
    ...
    qg = torch.rand(2, 21, 27, 2)

    a0, a1, a2, a3, a4 = net(x, xg1, xg2, xgp1, xgp2, y, yg1, yg2, ygp1, ygp2, q, qg)

    # export torchscript
    mod = torch.jit.trace(net, (x, xg1, xg2, xgp1, xgp2, y, yg1, yg2, ygp1, ygp2, q, qg))
    mod.save("test_F_grid_sample.pt")

    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_F_grid_sample.pt inputshape=[1,3,12,16],[1,21,27,2],[1,12,16,2],[1,2,21,27],[1,2,12,16],[1,5,10,12,16],[1,10,21,27,3],[1,10,12,16,3],[1,3,10,21,27],[1,3,10,12,16],[2,3,12,16],[2,21,27,2]")
