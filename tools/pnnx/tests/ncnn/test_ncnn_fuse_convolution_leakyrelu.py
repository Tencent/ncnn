...
def test():
    ...
    mod.save("test_ncnn_fuse_convolution_leakyrelu.pt")

    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_ncnn_fuse_convolution_leakyrelu.pt inputshape=[1,12,52,64]")

    # ncnn inference
    import test_ncnn_fuse_convolution_leakyrelu_ncnn
    b = test_ncnn_fuse_convolution_leakyrelu_ncnn.test_inference()
