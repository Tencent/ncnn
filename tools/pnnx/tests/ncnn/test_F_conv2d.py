...
def test():
    ...
    b0, ncnn_b1, b2 = test_F_conv2d_ncnn.test_inference()
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, w0, w1, b1, y, q), ["[1,12,52,64]", "[16,12,3,3]", "[16,8,5,5]", "[16]", "[1,6,32,25]", "[2,12,52,64]"], "test_F_conv2d")
