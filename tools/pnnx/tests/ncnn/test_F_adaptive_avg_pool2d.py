...
class Model(nn.Module):
    ...
    def forward(self, x, q):
        ...
        q = F.adaptive_avg_pool2d(q, output_size=(7,6))
...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_F_adaptive_avg_pool2d.pt inputshape=[1,12,24,64],[2,12,24,64]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, q), ["[1,12,24,64]", "[2,12,24,64]"], "test_F_adaptive_avg_pool2d")
