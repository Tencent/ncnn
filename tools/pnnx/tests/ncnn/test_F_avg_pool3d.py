...
class Model(nn.Module):
    ...
    def forward(self, x, q):
        ...
        q = F.avg_pool3d(q, kernel_size=3, stride=1)
        q = F.avg_pool3d(q, kernel_size=(5,4,3), stride=(2,1,1), padding=1, ceil_mode=False, count_include_pad=True)
        return x, y, q
...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_F_avg_pool3d.pt inputshape=[1,12,96,128,128],[2,3,8,10,12]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, q), ["[1,12,96,128,128]", "[2,3,8,10,12]"], "test_F_avg_pool3d")
