...
class ModelBatch(nn.Module):
    def __init__(self):
        ...
        self.deconv = nn.ConvTranspose2d(3, 4, kernel_size=3, padding=1)
...
def test_batch():
    ...
    # export torchscript
    mod = torch.jit.trace(net, x)
    mod.save("test_nn_ConvTranspose2d_batch.pt")

    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_nn_ConvTranspose2d_batch.pt inputshape=[2,3,7,9]")
