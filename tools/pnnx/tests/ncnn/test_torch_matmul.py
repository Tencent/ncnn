...
def test():
    ...
    pt2_ok = test_pnnx_ncnn(net, (a0, a1, b0, b1, c0, c1, d0, d1, e0, e1, f0, f1, g0, g1, h0, h1, i0, i1, j0, j1, k0, k1, l0, l1, m0, m1, n0, n1, o0, o1, p0, p1, q0, q1), ["[13]", "[13]", "[14]", "[14,6]", "[13]", "[7,13,4]", "[15]", "[5,7,15,9]", "[5,12]", "[12]", "[10,3,4]", "[4]", "[6,3,7,14]", "[14]", "[23,14]", "[14,25]", "[4,5]", "[10,5,40]", "[14,6]", "[2,4,6,20]", "[10,23,14]", "[14,5]", "[7,8,13,14]", "[14,35]", "[10,23,14]", "[10,14,5]", "[10,13,18]", "[3,1,18,8]", "[1,5,23,11]", "[8,1,11,9]", "[6,9,13,14]", "[6,9,14,15]", "[2,3,4,5]", "[2,3,5,6]"], "test_torch_matmul")
