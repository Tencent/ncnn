...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_F_relu6.pt inputshape=[16],[2,16],[3,12,16],[5,7,9,11],[2,7,9,11]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y, z, w, q), ["[16]", "[2,16]", "[3,12,16]", "[5,7,9,11]", "[2,7,9,11]"], "test_F_relu6")
