...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_nn_Hardtanh.pt inputshape=[12],[12,64],[12,24,64],[12,24,32,64],[2,3,5,7]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y, z, w, q), ["[12]", "[12,64]", "[12,24,64]", "[12,24,32,64]", "[2,3,5,7]"], "test_nn_Hardtanh")
