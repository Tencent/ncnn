...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_nn_BatchNorm1d.pt inputshape=[1,32,64],[1,11,1],[2,32,64]")

    # ncnn inference
    import test_nn_BatchNorm1d_ncnn
    b0, b1, b2 = test_nn_BatchNorm1d_ncnn.test_inference()
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y, q), ["[1,32,64]", "[1,11,1]", "[2,32,64]"], "test_nn_BatchNorm1d")
