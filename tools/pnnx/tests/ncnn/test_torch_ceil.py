...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system("../../src/pnnx test_torch_ceil.pt inputshape=[3,16],[5,9,11],[8,5,9,10],[2,3,5,7]")
    ...
    pt2_ok = test_pnnx_ncnn(net, (x, y, z, w), ["[3,16]", "[5,9,11]", "[8,5,9,10]", "[2,3,5,7]"], "test_torch_ceil")
