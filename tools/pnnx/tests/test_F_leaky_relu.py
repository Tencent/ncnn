...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_F_leaky_relu.pt inputshape=[1,16],[12,2,16],[1,3,12,16],[1,5,7,9,11]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z, w), ["[1,16]", "[12,2,16]", "[1,3,12,16]", "[1,5,7,9,11]"], "test_F_leaky_relu")
