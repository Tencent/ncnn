...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_LocalResponseNorm.pt inputshape=[1,24,64],[1,12,24,64],[1,12,16,24,64]")
    ...
    pt2_ok = test_pnnx(net, (x, y, z), ["[1,24,64]", "[1,12,24,64]", "[1,12,16,24,64]"], "test_nn_LocalResponseNorm")
