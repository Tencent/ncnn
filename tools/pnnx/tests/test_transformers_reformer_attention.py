...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_transformers_reformer_attention.pt inputshape=[3,16,192],[2,5,66],[2,5]")
    ...
    pt2_ok = test_pnnx(net, (x, y, mask), ["[3,16,192]", "[2,5,66]", "[2,5]"], "test_transformers_reformer_attention")
