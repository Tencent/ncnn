...
def test():
    ...
    # torchscript to pnnx
    import os
    os.system(os.path.join("..", "src", "pnnx") + " test_nn_PixelUnshuffle.pt inputshape=[1,3,128,128],[1,12,4,192,192]")
    ...
    pt2_ok = test_pnnx(net, (x, y), ["[1,3,128,128]", "[1,12,4,192,192]"], "test_nn_PixelUnshuffle")
