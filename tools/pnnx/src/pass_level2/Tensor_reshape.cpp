...
class Tensor_reshape_unsafe_view : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
pnnx.Input              input_0     0 1 input
pnnx.Input              input_1     0 1 shape
aten::_unsafe_view      op_0        2 1 input shape out
pnnx.Output             output      1 0 out
)PNNXIR";
    }
...
REGISTER_GLOBAL_PNNX_GRAPH_REWRITER_PASS(Tensor_reshape_unsafe_view, 60)
