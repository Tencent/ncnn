...
class F_conv_transpose2d_aten : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
aten::conv_transpose2d  op_0        8 1 input weight bias stride padding output_padding groups dilation out
pnnx.Output             output      1 0 out
)PNNXIR";
    }
...
REGISTER_GLOBAL_PNNX_GRAPH_REWRITER_PASS(F_conv_transpose2d_aten, 140)
