...
pnnx.Output             output      1 0 out
    ...
    {
        op->params["output_size"] = {captured_params.at("pooled_height").i, captured_params.at("pooled_width").i};
...
REGISTER_GLOBAL_PNNX_GRAPH_REWRITER_PASS(torchvision_RoIAlign, 140)
