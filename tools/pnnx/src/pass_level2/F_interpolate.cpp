...
class F_interpolate_nearest_exact2d_vec : public F_interpolate_nearest_exact1d_1
{
public:
    const char* match_pattern_graph() const
    {
...
REGISTER_GLOBAL_PNNX_GRAPH_REWRITER_PASS(F_interpolate_nearest_exact2d_vec, 110)
...
class F_interpolate_nearest_exact3d_vec : public F_interpolate_nearest_exact1d_1
{
public:
    const char* match_pattern_graph() const
    {
...
REGISTER_GLOBAL_PNNX_GRAPH_REWRITER_PASS(F_interpolate_nearest_exact3d_vec, 110)
