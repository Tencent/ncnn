...
static void set_log_softmax_dtype_param(Operator* op, const std::map<std::string, Parameter>& captured_params)
{
...
pnnx.Output             output      1 0 out
    ...
    void write(Operator* op, const std::map<std::string, Parameter>& captured_params) const
    {
        ...
        // compute log_softmax in the input's dtype (dtype=torch.float64
