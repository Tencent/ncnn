...
class torch_rand_like : public GraphRewriterPass
{
public:
...
aten::rand_like         op_5        6 1 input dtype layout device requires_grad memory_format out
...
REGISTER_GLOBAL_PNNX_GRAPH_REWRITER_PASS(torch_rand_like, 20)
