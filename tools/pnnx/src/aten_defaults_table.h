...
inline const Pt2DefaultsEntry* find_pt2_aten_defaults(const char* op)
{
    ...
    static const Pt2ArgDefault args_aten_argmax_default[] = {
        {"self", PT2_D_NO_DEFAULT, ""},
        {"dim", PT2_D_NONE, ""},
        {"keepdim", PT2_D_BOOL, "0"},
    };
    static const Pt2DefaultsEntry entry_aten_argmax_default = {"aten::argmax.default", args_aten_argmax_default, 3};
    if (strcmp(op, entry_aten_argmax_default.op) == 0) return &entry_aten_argmax_default;

    static const Pt2ArgDefault args_aten_argmin_default[] = {
        {"self", PT2_D_NO_DEFAULT, ""},
        {"dim", PT2_D_NONE, ""},
        {"keepdim", PT2_D_BOOL, "0"},
    };
    static const Pt2DefaultsEntry entry_aten_argmin_default = {"aten::argmin.default", args_aten_argmin_default, 3};
    if (strcmp(op, entry_aten_argmin_default.op) == 0) return &entry_aten_argmin_default;
