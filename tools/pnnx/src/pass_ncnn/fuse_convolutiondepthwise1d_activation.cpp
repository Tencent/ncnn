...
class fuse_convolutiondepthwise1d_gelu_fast_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_convolutiondepthwise1d_activation(Graph& graph)
{
    ...
    fuse_convolutiondepthwise1d_gelu_pass f;
    fuse_convolutiondepthwise1d_gelu_fast_pass f2;
    fuse_convolutiondepthwise1d_silu_pass g;
    fuse_convolutiondepthwise1d_elu_pass h;
    fuse_convolutiondepthwise1d_selu_pass i;
    int opindex = 0;
