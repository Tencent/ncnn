...
class fuse_deconvolution3d_hardswish_f_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_deconvolution3d_leakyrelu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_deconvolution3d_gelu_tanh_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_deconvolution3d_activation(Graph& graph)
{
    ...
    fuse_deconvolution3d_hardswish_f_pass f;
    fuse_deconvolution3d_leakyrelu_pass g;
    fuse_deconvolution3d_gelu_pass h;
    fuse_deconvolution3d_gelu_tanh_pass h2;
    fuse_deconvolution3d_silu_pass i;
    fuse_deconvolution3d_elu_pass j;
    fuse_deconvolution3d_selu_pass k;
    int opindex = 0;
