...
class fuse_convolution_gelu_fast_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_convolution_activation(Graph& graph)
{
    ...
    fuse_convolution_gelu_pass f;
    fuse_convolution_gelu_fast_pass g;
    fuse_convolution_silu_pass h;
    fuse_convolution_elu_pass i;
    fuse_convolution_selu_pass j;
    int opindex = 0;
