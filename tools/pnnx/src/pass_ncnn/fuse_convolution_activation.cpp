...
class fuse_convolution_hardswish_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_hardswish_f_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_leakyrelu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_gelu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_gelu_tanh_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_silu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_elu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolution_selu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_convolution_activation(Graph& graph)
{
    ...
    fuse_convolution_hardswish_pass e;
    fuse_convolution_hardswish_f_pass f;
    fuse_convolution_leakyrelu_pass g;
    fuse_convolution_gelu_pass h;
    fuse_convolution_gelu_tanh_pass h2;
    fuse_convolution_silu_pass i;
    fuse_convolution_elu_pass j;
    fuse_convolution_selu_pass k;
    int opindex = 0;
