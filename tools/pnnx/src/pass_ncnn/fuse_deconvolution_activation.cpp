...
class fuse_deconvolution_gelu_fast_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_deconvolution_activation(Graph& graph)
{
    ...
    fuse_deconvolution_gelu_pass f;
    fuse_deconvolution_gelu_fast_pass f2;
    fuse_deconvolution_silu_pass g;
    fuse_deconvolution_elu_pass h;
    fuse_deconvolution_selu_pass i;
    int opindex = 0;
