...
class fuse_deconvolution1d_hardswish_f_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_deconvolution1d_leakyrelu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_deconvolution1d_gelu_tanh_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_deconvolution1d_activation(Graph& graph)
{
    ...
    fuse_deconvolution1d_hardswish_f_pass f;
    fuse_deconvolution1d_leakyrelu_pass g;
    fuse_deconvolution1d_gelu_pass h;
    fuse_deconvolution1d_gelu_tanh_pass h2;
