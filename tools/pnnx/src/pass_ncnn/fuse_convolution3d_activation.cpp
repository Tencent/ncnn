...
class fuse_convolution3d_gelu_fast_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_convolution3d_activation(Graph& graph)
{
    ...
    fuse_convolution3d_gelu_pass f;
    fuse_convolution3d_gelu_fast_pass f2;
    fuse_convolution3d_silu_pass g;
    fuse_convolution3d_elu_pass h;
    fuse_convolution3d_selu_pass i;
    int opindex = 0;
