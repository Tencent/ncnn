...
pnnx.Output             output      2 0 out0 out1
    ...
    void write(const std::map<std::string, Operator*>& ops, const std::map<std::string, Parameter>& captured_params, const std::map<std::string, Attribute>& captured_attrs) const
    {
        ...
        const int batch_in_shape = ops.at("shufflechannel")->inputs[0]->params["__ncnn_batch_in_shape"].i;
        ...
        ops.at("slice")->inputs[0]->params["__ncnn_batch_in_shape"] = batch_in_shape;
        ops.at("slice")->outputs[0]->params["__ncnn_batch_in_shape"] = batch_in_shape;
        ops.at("slice")->outputs[1]->params["__ncnn_batch_in_shape"] = batch_in_shape;
    }
};
