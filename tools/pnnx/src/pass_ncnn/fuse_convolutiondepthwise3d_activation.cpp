...
#include "fuse_convolutiondepthwise3d_activation.h"
...
class fuse_convolutiondepthwise3d_relu_pass : public GraphRewriterPass
{
public:
...
ConvolutionDepthWise3D  op_0        1 1 input a %*=%*
ReLU                    op_1        1 1 a out %*=%*
...
class fuse_convolutiondepthwise3d_clip_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_sigmoid_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_mish_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_hardswish_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_hardswish_f_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_leakyrelu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_gelu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_gelu_tanh_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_silu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_elu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
class fuse_convolutiondepthwise3d_selu_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_convolutiondepthwise3d_activation(Graph& graph)
{
    fuse_convolutiondepthwise3d_relu_pass a;
    fuse_convolutiondepthwise3d_clip_pass b;
    fuse_convolutiondepthwise3d_sigmoid_pass c;
    fuse_convolutiondepthwise3d_mish_pass d;
    fuse_convolutiondepthwise3d_hardswish_pass e;
    fuse_convolutiondepthwise3d_hardswish_f_pass f;
    fuse_convolutiondepthwise3d_leakyrelu_pass g;
    fuse_convolutiondepthwise3d_gelu_pass h;
    fuse_convolutiondepthwise3d_gelu_tanh_pass h2;
    fuse_convolutiondepthwise3d_silu_pass i;
    fuse_convolutiondepthwise3d_elu_pass j;
    fuse_convolutiondepthwise3d_selu_pass k;
    int opindex = 0;
