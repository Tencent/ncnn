...
class fuse_deconvolutiondepthwise_gelu_fast_pass : public GraphRewriterPass
{
public:
    const char* match_pattern_graph() const
    {
...
void fuse_deconvolutiondepthwise_activation(Graph& graph)
{
    ...
    fuse_deconvolutiondepthwise_gelu_pass g;
    fuse_deconvolutiondepthwise_gelu_fast_pass g2;
    fuse_deconvolutiondepthwise_silu_pass h;
    fuse_deconvolutiondepthwise_elu_pass i;
    fuse_deconvolutiondepthwise_selu_pass j;
    int opindex = 0;
