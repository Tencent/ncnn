...
On Debian, Ubuntu or Raspberry Pi OS, you can install all required dependencies using: `sudo apt install build-essentials git cmake libprotobuf-dev protobuf-compiler libvulkan-dev glslang-tools vulkan-tools libopencv-dev`
