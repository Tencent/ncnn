...
int main(int argc, char** argv)
{
    ...
    for(t=0;t<Boards.size();t++){
        ...
        for(n=Boards[t].StartLine;n<Boards[t].EndLine;n++){
            ...
            if(Model.Name=="squeezenet"){
                ...
                else         Boards[t].BenchSet.push_back(MdSet);
            }
        }
    ...
    if (outputFile.is_open()) {
        ...
        outputFile << "The set is then compared to a reference set by calculating the ratio of each model one by one and averaging all results." << endl;
