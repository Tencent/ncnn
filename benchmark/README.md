...
cd /data/local/tmp/
./benchncnn [loop count] [num threads] [powersave] [gpu device] [cooling down]  [specified_model w h c]
```
...
|model|user specified basename|nullptr|
|w|1~N|-|
|h|1~N|-|
|c|1~N|-|
...
```bash
$ ./benchncnn 4 1 0 -1 1 squeezenet 227 227 3
loop_count = 4
num_threads = 1
powersave = 0
gpu_device = -1
