...
#if __loongarch_asx
// LASX (256-bit) overloads that split into two LSX (128-bit) operations
static inline __m256 log_ps(__m256 x)
{
    __m128 lo = log_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = log_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 exp_ps(__m256 x)
{
    __m128 lo = exp_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = exp_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 tanh_ps(__m256 x)
{
    __m128 lo = tanh_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = tanh_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 sin_ps(__m256 x)
{
    __m128 lo = sin_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = sin_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 cos_ps(__m256 x)
{
    __m128 lo = cos_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = cos_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 tan_ps(__m256 x)
{
    __m128 lo = tan_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = tan_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 pow_ps(__m256 a, __m256 b)
{
    __m128 lo = pow_ps((__m128)__lasx_extract_lo128((__m256i)a), (__m128)__lasx_extract_lo128((__m256i)b));
    __m128 hi = pow_ps((__m128)__lasx_extract_hi128((__m256i)a), (__m128)__lasx_extract_hi128((__m256i)b));
    return combine4x2_ps(lo, hi);
}

static inline __m256 sigmoid_ps(__m256 _v)
{
    __m128 lo = sigmoid_ps((__m128)__lasx_extract_lo128((__m256i)_v));
    __m128 hi = sigmoid_ps((__m128)__lasx_extract_hi128((__m256i)_v));
    return combine4x2_ps(lo, hi);
}

static inline __m256 asin_ps(__m256 x)
{
    __m128 lo = asin_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = asin_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 acos_ps(__m256 x)
{
    __m128 lo = acos_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = acos_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 atan_ps(__m256 x)
{
    __m128 lo = atan_ps((__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = atan_ps((__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 atan2_ps(__m256 y, __m256 x)
{
    __m128 lo = atan2_ps((__m128)__lasx_extract_lo128((__m256i)y), (__m128)__lasx_extract_lo128((__m256i)x));
    __m128 hi = atan2_ps((__m128)__lasx_extract_hi128((__m256i)y), (__m128)__lasx_extract_hi128((__m256i)x));
    return combine4x2_ps(lo, hi);
}

static inline __m256 fmod_ps(__m256 a, __m256 b)
{
...
static inline __m256 logaddexp_ps(__m256 a, __m256 b)
{
...
static inline __m256 floor_divide_ps(__m256 a, __m256 b)
{
...
static inline __m256 remainder_ps(__m256 a, __m256 b)
{
