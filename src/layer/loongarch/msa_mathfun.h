...
static inline v4f32 log_ps(v4f32 x)
{
    ...
    __m128i invalid_mask = (__m128i)__lsx_vfcmp_cle_s(x, (v4f32)__lsx_vreplgr2vr_w(0));

    __m128i ux = (__m128i)(x);

    __m128i emm0 = (__m128i)__lsx_vsrl_w(ux, (__m128i)__lsx_vreplgr2vr_w(23));

    /* keep only the fractional part */
    ux = __lsx_vand_v(ux, (__m128i)__lsx_vreplgr2vr_w(c_inv_mant_mask));
    ux = __lsx_vor_v(ux, (__m128i)__lsx_vreplgr2vr_w(c_0p5.i));
    x = (v4f32)(ux);

    emm0 = __lsx_vsub_w(emm0, (__m128i)__lsx_vreplgr2vr_w(0x7f));
    v4f32 e = (v4f32)__lsx_vffint_s_w(emm0);
    ...
    v4f32 tmp = (v4f32)(__lsx_vand_v((__m128i)(x), (__m128i)mask));
    x = __lsx_vfsub_s(x, one);
    e = __lsx_vfsub_s(e, (v4f32)(__lsx_vand_v((__m128i)(one), (__m128i)mask)));
    ...
    x = __lsx_vfadd_s(x, y);
    x = __lsx_vfadd_s(x, tmp);
    x = (v4f32)(__lsx_vor_v((__m128i)(x), (__m128i)invalid_mask)); // negative arg will be NAN
    return x;
}
...
static inline v4f32 exp_ps(v4f32 x)
{
    ...
    __m128i mask = (__m128i)__lsx_vfcmp_clt_s((__m128)fx, (__m128)tmp);
    mask = (__m128i)__lsx_vand_v((__m128i)mask, (__m128i)one);
    ...
    /* build 2^n */
    __m128i mm;
    mm = __lsx_vftintrz_w_s((__m128)fx);
    mm = __lsx_vadd_w((__m128i)mm, (__m128i)__lsx_vreplgr2vr_w(0x7f));
    mm = __lsx_vsll_w(mm, (__m128i)__lsx_vreplgr2vr_w(23));
...
static inline v4f32 tanh_ps(v4f32 x)
{
    ...
    x2 = (v4f32)__lsx_vbitsel_v((__m128i)__lsx_vfcmp_clt_s((__m128)__lsx_vreplgr2vr_w(c_tanh_hi.i), (__m128)x2), (__m128i)x2, (__m128i)__lsx_vreplgr2vr_w(c_tanh_hi.i));
...
{
    v4f32 _one = __lsx_vreplfr2vr_s(1.f);
    _v = (v4f32)__lsx_vbitrevi_w((__m128i)_v, 31);
    _v = exp_ps(_v);
