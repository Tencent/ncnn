    ...
    for (; ii + 7 < max_ii; ii += 8)
    {
        ...
        for (; jj + 15 < max_jj; jj += 16)
        {
            ...
            if (k_end)
            {
                ...
                _suma = activation_lasx(_suma, activation_type, activation_params);
                _sumb = activation_lasx(_sumb, activation_type, activation_params);
                _sumc = activation_lasx(_sumc, activation_type, activation_params);
                _sumd = activation_lasx(_sumd, activation_type, activation_params);
                _sume = activation_lasx(_sume, activation_type, activation_params);
                _sumf = activation_lasx(_sumf, activation_type, activation_params);

                if (out_elempack == 8)
                {
                    __lsx_vst(float2bfloat_lasx(_sum0), outptr0, 0);
                    ...
                    __lsx_vst(float2bfloat_lasx(_suma), outptr0 + 80, 0);
                    __lsx_vst(float2bfloat_lasx(_sumb), outptr0 + 88, 0);
                    __lsx_vst(float2bfloat_lasx(_sumc), outptr0 + 96, 0);
                    __lsx_vst(float2bfloat_lasx(_sumd), outptr0 + 104, 0);
                    __lsx_vst(float2bfloat_lasx(_sume), outptr0 + 112, 0);
                    __lsx_vst(float2bfloat_lasx(_sumf), outptr0 + 120, 0);
                    outptr0 += 128;
                }
                if (out_elempack == 4)
                {
                    __m256 _tmp0l = (__m256)__lasx_xvpermi_q((__m256i)_sum1, (__m256i)_sum0, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmp0h = (__m256)__lasx_xvpermi_q((__m256i)_sum1, (__m256i)_sum0, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmp2l = (__m256)__lasx_xvpermi_q((__m256i)_sum3, (__m256i)_sum2, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmp2h = (__m256)__lasx_xvpermi_q((__m256i)_sum3, (__m256i)_sum2, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmp4l = (__m256)__lasx_xvpermi_q((__m256i)_sum5, (__m256i)_sum4, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmp4h = (__m256)__lasx_xvpermi_q((__m256i)_sum5, (__m256i)_sum4, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmp6l = (__m256)__lasx_xvpermi_q((__m256i)_sum7, (__m256i)_sum6, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmp6h = (__m256)__lasx_xvpermi_q((__m256i)_sum7, (__m256i)_sum6, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmp8l = (__m256)__lasx_xvpermi_q((__m256i)_sum9, (__m256i)_sum8, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmp8h = (__m256)__lasx_xvpermi_q((__m256i)_sum9, (__m256i)_sum8, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmpal = (__m256)__lasx_xvpermi_q((__m256i)_sumb, (__m256i)_suma, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmpah = (__m256)__lasx_xvpermi_q((__m256i)_sumb, (__m256i)_suma, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmpcl = (__m256)__lasx_xvpermi_q((__m256i)_sumd, (__m256i)_sumc, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmpch = (__m256)__lasx_xvpermi_q((__m256i)_sumd, (__m256i)_sumc, _LSX_SHUFFLE(0, 3, 0, 1));
                    __m256 _tmpel = (__m256)__lasx_xvpermi_q((__m256i)_sumf, (__m256i)_sume, _LSX_SHUFFLE(0, 2, 0, 0));
                    __m256 _tmpeh = (__m256)__lasx_xvpermi_q((__m256i)_sumf, (__m256i)_sume, _LSX_SHUFFLE(0, 3, 0, 1));

                    __lsx_vst(float2bfloat_lasx(_tmp0l), outptr0, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp2l), outptr0 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp4l), outptr0 + 16, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp6l), outptr0 + 24, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp8l), outptr0 + 32, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpal), outptr0 + 40, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpcl), outptr0 + 48, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpel), outptr0 + 56, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp0h), outptr0 + out_hstep * 4, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp2h), outptr0 + out_hstep * 4 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp4h), outptr0 + out_hstep * 4 + 16, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp6h), outptr0 + out_hstep * 4 + 24, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp8h), outptr0 + out_hstep * 4 + 32, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpah), outptr0 + out_hstep * 4 + 40, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpch), outptr0 + out_hstep * 4 + 48, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpeh), outptr0 + out_hstep * 4 + 56, 0);
                    outptr0 += 64;
                }
                if (out_elempack == 1)
                {
                    ...
                    __lsx_vst(float2bfloat_lasx(_sum0), outptr0, 0);
                    __lsx_vst(float2bfloat_lasx(_sum1), outptr0 + out_hstep, 0);
                    __lsx_vst(float2bfloat_lasx(_sum2), outptr0 + out_hstep * 2, 0);
                    __lsx_vst(float2bfloat_lasx(_sum3), outptr0 + out_hstep * 3, 0);
                    __lsx_vst(float2bfloat_lasx(_sum4), outptr0 + out_hstep * 4, 0);
                    __lsx_vst(float2bfloat_lasx(_sum5), outptr0 + out_hstep * 5, 0);
                    __lsx_vst(float2bfloat_lasx(_sum6), outptr0 + out_hstep * 6, 0);
                    __lsx_vst(float2bfloat_lasx(_sum7), outptr0 + out_hstep * 7, 0);
                    __lsx_vst(float2bfloat_lasx(_sum8), outptr0 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_sum9), outptr0 + out_hstep + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_suma), outptr0 + out_hstep * 2 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_sumb), outptr0 + out_hstep * 3 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_sumc), outptr0 + out_hstep * 4 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_sumd), outptr0 + out_hstep * 5 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_sume), outptr0 + out_hstep * 6 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_sumf), outptr0 + out_hstep * 7 + 8, 0);
                    outptr0 += 16;
                }
            }
            else
        ...
        for (; jj + 7 < max_jj; jj += 8)
        {
            ...
            if (k_end)
            {
                ...
                _sum00 = activation_lsx(_sum00, activation_type, activation_params);
                _sum10 = activation_lsx(_sum10, activation_type, activation_params);
                _sum20 = activation_lsx(_sum20, activation_type, activation_params);
                _sum30 = activation_lsx(_sum30, activation_type, activation_params);
                _sum40 = activation_lsx(_sum40, activation_type, activation_params);
                _sum50 = activation_lsx(_sum50, activation_type, activation_params);
                _sum60 = activation_lsx(_sum60, activation_type, activation_params);
                _sum70 = activation_lsx(_sum70, activation_type, activation_params);
                _sum01 = activation_lsx(_sum01, activation_type, activation_params);
                _sum11 = activation_lsx(_sum11, activation_type, activation_params);
                _sum21 = activation_lsx(_sum21, activation_type, activation_params);
                _sum31 = activation_lsx(_sum31, activation_type, activation_params);
                _sum41 = activation_lsx(_sum41, activation_type, activation_params);
                _sum51 = activation_lsx(_sum51, activation_type, activation_params);
                _sum61 = activation_lsx(_sum61, activation_type, activation_params);
                _sum71 = activation_lsx(_sum71, activation_type, activation_params);

                if (out_elempack == 8)
                {
                    __lsx_vst(float2bfloat_lsx(_sum00, _sum01), outptr0, 0);
                    __lsx_vst(float2bfloat_lsx(_sum10, _sum11), outptr0 + 8, 0);
                    __lsx_vst(float2bfloat_lsx(_sum20, _sum21), outptr0 + 16, 0);
                    __lsx_vst(float2bfloat_lsx(_sum30, _sum31), outptr0 + 24, 0);
                    __lsx_vst(float2bfloat_lsx(_sum40, _sum41), outptr0 + 32, 0);
                    __lsx_vst(float2bfloat_lsx(_sum50, _sum51), outptr0 + 40, 0);
                    __lsx_vst(float2bfloat_lsx(_sum60, _sum61), outptr0 + 48, 0);
                    __lsx_vst(float2bfloat_lsx(_sum70, _sum71), outptr0 + 56, 0);
                    outptr0 += 64;
                }
                if (out_elempack == 4)
                {
        ...
        for (; jj + 1 < max_jj; jj += 2)
        {
            ...
            if (k_end)
            {
                ...
                if (out_elempack == 1)
                {
                    ...
                    outptr0[0] = float32_to_bfloat16(sum00[0]);
                    outptr0[1] = float32_to_bfloat16(sum10[0]);
                    outptr0[out_hstep] = float32_to_bfloat16(sum00[1]);
                    outptr0[out_hstep + 1] = float32_to_bfloat16(sum10[1]);
                    outptr0[out_hstep * 2] = float32_to_bfloat16(sum00[2]);
                    outptr0[out_hstep * 2 + 1] = float32_to_bfloat16(sum10[2]);
                    outptr0[out_hstep * 3] = float32_to_bfloat16(sum00[3]);
                    outptr0[out_hstep * 3 + 1] = float32_to_bfloat16(sum10[3]);
                    outptr0[out_hstep * 4] = float32_to_bfloat16(sum01[0]);
                    outptr0[out_hstep * 4 + 1] = float32_to_bfloat16(sum11[0]);
                    outptr0[out_hstep * 5] = float32_to_bfloat16(sum01[1]);
                    outptr0[out_hstep * 5 + 1] = float32_to_bfloat16(sum11[1]);
                    outptr0[out_hstep * 6] = float32_to_bfloat16(sum01[2]);
                    outptr0[out_hstep * 6 + 1] = float32_to_bfloat16(sum11[2]);
                    outptr0[out_hstep * 7] = float32_to_bfloat16(sum01[3]);
                    outptr0[out_hstep * 7 + 1] = float32_to_bfloat16(sum11[3]);
                    outptr0 += 2;
                }
            }
            else
        ...
        for (; jj < max_jj; jj += 1)
        {
            ...
            if (k_end)
            {
                ...
                if (out_elempack == 1)
                {
                    ...
                    outptr0[out_hstep * 0] = float32_to_bfloat16(sum0[0]);
                    ...
                    outptr0[out_hstep * 4] = float32_to_bfloat16(sum1[0]);
                    outptr0[out_hstep * 5] = float32_to_bfloat16(sum1[1]);
                    outptr0[out_hstep * 6] = float32_to_bfloat16(sum1[2]);
                    outptr0[out_hstep * 7] = float32_to_bfloat16(sum1[3]);
                    outptr0++;
                }
            }
            else
    ...
    for (; ii + 3 < max_ii; ii += 4)
    {
        ...
        for (; jj + 15 < max_jj; jj += 16)
        {
            ...
            if (k_end)
            {
                ...
                _sum04 = activation_lasx(_sum04, activation_type, activation_params);
                _sum15 = activation_lasx(_sum15, activation_type, activation_params);
                _sum26 = activation_lasx(_sum26, activation_type, activation_params);
                _sum37 = activation_lasx(_sum37, activation_type, activation_params);
                _sum8c = activation_lasx(_sum8c, activation_type, activation_params);
                _sum9d = activation_lasx(_sum9d, activation_type, activation_params);
                _sumae = activation_lasx(_sumae, activation_type, activation_params);
                _sumbf = activation_lasx(_sumbf, activation_type, activation_params);
                ...
                if (out_elempack == 4)
                {
                    ...
                    __lsx_vst(float2bfloat_lasx(_tmp04l), outptr0, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp26l), outptr0 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp04h), outptr0 + 16, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp26h), outptr0 + 24, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp8cl), outptr0 + 32, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpael), outptr0 + 40, 0);
                    __lsx_vst(float2bfloat_lasx(_tmp8ch), outptr0 + 48, 0);
                    __lsx_vst(float2bfloat_lasx(_tmpaeh), outptr0 + 56, 0);
                    outptr0 += 64;
                }
                if (out_elempack == 1)
                {
                    ...
                    __lsx_vst(float2bfloat_lasx(_row0a), outptr0, 0);
                    __lsx_vst(float2bfloat_lasx(_row0b), outptr0 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_row1a), outptr0 + out_hstep, 0);
                    __lsx_vst(float2bfloat_lasx(_row1b), outptr0 + out_hstep + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_row2a), outptr0 + out_hstep * 2, 0);
                    __lsx_vst(float2bfloat_lasx(_row2b), outptr0 + out_hstep * 2 + 8, 0);
                    __lsx_vst(float2bfloat_lasx(_row3a), outptr0 + out_hstep * 3, 0);
                    __lsx_vst(float2bfloat_lasx(_row3b), outptr0 + out_hstep * 3 + 8, 0);
                    outptr0 += 16;
                }
            }
            else
        ...
        for (; jj + 1 < max_jj; jj += 2)
        {
            ...
            if (k_end)
            {
                ...
                if (out_elempack == 1)
                {
                    ...
                    outptr0[out_hstep * 2] = float32_to_bfloat16(sum0[2]);
                    outptr0[out_hstep * 3] = float32_to_bfloat16(sum0[3]);
                    outptr0[1] = float32_to_bfloat16(sum1[0]);
                    outptr0[out_hstep + 1] = float32_to_bfloat16(sum1[1]);
                    outptr0[out_hstep * 2 + 1] = float32_to_bfloat16(sum1[2]);
                    outptr0[out_hstep * 3 + 1] = float32_to_bfloat16(sum1[3]);
                    outptr0 += 2;
                }
    ...
    for (; ii + 1 < max_ii; ii += 2)
    {
        ...
        for (; jj + 15 < max_jj; jj += 16)
        {
            ...
            for (; kk < max_kk; kk += 1)
            {
                ...
                __m256 _pA0 = __lasx_xvreplfr2vr_s(bfloat16_to_float32(pA[0]));
                _sum00 = __lasx_xvfmadd_s(_pA0, _pB0, _sum00);
                _sum01 = __lasx_xvfmadd_s(_pA0, _pB1, _sum01);
                __m256 _pA1 = __lasx_xvreplfr2vr_s(bfloat16_to_float32(pA[1]));
            ...
            if (k_end)
            {
                _sum00 = activation_lasx(_sum00, activation_type, activation_params);
                _sum01 = activation_lasx(_sum01, activation_type, activation_params);
                ...
                __lsx_vst(float2bfloat_lasx(_sum00), outptr0, 0);
                __lsx_vst(float2bfloat_lasx(_sum01), outptr0 + 8, 0);
                __lsx_vst(float2bfloat_lasx(_sum10), outptr0 + out_hstep, 0);
                __lsx_vst(float2bfloat_lasx(_sum11), outptr0 + out_hstep + 8, 0);
                outptr0 += 16;
            }
            else
            {
    ...
    for (; jj + 15 < max_jj; jj += 16)
    {
        if (elempack == 8)
        {
            ...
            for (; kk + 7 < max_kk; kk += 8)
            {
                ...
                __m128i _r8 = __lsx_vld(p0 + 8 * 8, 0);
                __m128i _r9 = __lsx_vld(p0 + 8 * 9, 0);
                __m128i _ra = __lsx_vld(p0 + 8 * 10, 0);
                __m128i _rb = __lsx_vld(p0 + 8 * 11, 0);
                __m128i _rc = __lsx_vld(p0 + 8 * 12, 0);
                __m128i _rd = __lsx_vld(p0 + 8 * 13, 0);
                __m128i _re = __lsx_vld(p0 + 8 * 14, 0);
                __m128i _rf = __lsx_vld(p0 + 8 * 15, 0);
                transpose8x8_epi16(_r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7);
                transpose8x8_epi16(_r8, _r9, _ra, _rb, _rc, _rd, _re, _rf);
                __lsx_vst(_r0, pp, 0);
                __lsx_vst(_r8, pp + 8, 0);
                __lsx_vst(_r1, pp + 8 * 2, 0);
                __lsx_vst(_r9, pp + 8 * 3, 0);
                __lsx_vst(_r2, pp + 8 * 4, 0);
                __lsx_vst(_ra, pp + 8 * 5, 0);
                __lsx_vst(_r3, pp + 8 * 6, 0);
                __lsx_vst(_rb, pp + 8 * 7, 0);
                __lsx_vst(_r4, pp + 8 * 8, 0);
                __lsx_vst(_rc, pp + 8 * 9, 0);
                __lsx_vst(_r5, pp + 8 * 10, 0);
                __lsx_vst(_rd, pp + 8 * 11, 0);
                __lsx_vst(_r6, pp + 8 * 12, 0);
                __lsx_vst(_re, pp + 8 * 13, 0);
                __lsx_vst(_r7, pp + 8 * 14, 0);
                __lsx_vst(_rf, pp + 8 * 15, 0);
                pp += 128;
        ...
        if (elempack == 4)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                __m128i _r1 = __lsx_vldrepl_d(p0 + 4, 0);
                __m128i _r2 = __lsx_vldrepl_d(p0 + 8, 0);
                __m128i _r3 = __lsx_vldrepl_d(p0 + 12, 0);
                __m128i _r4 = __lsx_vldrepl_d(p0 + 16, 0);
                __m128i _r5 = __lsx_vldrepl_d(p0 + 20, 0);
                __m128i _r6 = __lsx_vldrepl_d(p0 + 24, 0);
                __m128i _r7 = __lsx_vldrepl_d(p0 + 28, 0);
                __m128i _r8 = __lsx_vldrepl_d(p0 + 32, 0);
                __m128i _r9 = __lsx_vldrepl_d(p0 + 36, 0);
                __m128i _ra = __lsx_vldrepl_d(p0 + 40, 0);
                __m128i _rb = __lsx_vldrepl_d(p0 + 44, 0);
                __m128i _rc = __lsx_vldrepl_d(p0 + 48, 0);
                __m128i _rd = __lsx_vldrepl_d(p0 + 52, 0);
                __m128i _re = __lsx_vldrepl_d(p0 + 56, 0);
                __m128i _rf = __lsx_vldrepl_d(p0 + 60, 0);
                ...
                __lsx_vstelm_d(_r0, pp, 0, 0);
                __lsx_vstelm_d(_r4, pp + 4, 0, 0);
                __lsx_vstelm_d(_r8, pp + 8, 0, 0);
                __lsx_vstelm_d(_rc, pp + 12, 0, 0);
                __lsx_vstelm_d(_r0, pp + 16, 0, 1);
                __lsx_vstelm_d(_r4, pp + 20, 0, 1);
                __lsx_vstelm_d(_r8, pp + 24, 0, 1);
                __lsx_vstelm_d(_rc, pp + 28, 0, 1);
                __lsx_vstelm_d(_r1, pp + 32, 0, 0);
                __lsx_vstelm_d(_r5, pp + 36, 0, 0);
                __lsx_vstelm_d(_r9, pp + 40, 0, 0);
                __lsx_vstelm_d(_rd, pp + 44, 0, 0);
                __lsx_vstelm_d(_r1, pp + 48, 0, 1);
                __lsx_vstelm_d(_r5, pp + 52, 0, 1);
                __lsx_vstelm_d(_r9, pp + 56, 0, 1);
                __lsx_vstelm_d(_rd, pp + 60, 0, 1);
                pp += 64;
    ...
    for (; jj + 7 < max_jj; jj += 8)
    {
        ...
        if (elempack == 4)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                __lsx_vstelm_d(_r0, pp, 0, 0);
                __lsx_vstelm_d(_r4, pp + 4, 0, 0);
                __lsx_vstelm_d(_r0, pp + 8, 0, 1);
                __lsx_vstelm_d(_r4, pp + 12, 0, 1);
                __lsx_vstelm_d(_r1, pp + 16, 0, 0);
                __lsx_vstelm_d(_r5, pp + 20, 0, 0);
                __lsx_vstelm_d(_r1, pp + 24, 0, 1);
                __lsx_vstelm_d(_r5, pp + 28, 0, 1);
                pp += 32;
                p0 += bottom_blob.cstep * 4;
            }
        }
    ...
    for (; jj + 3 < max_jj; jj += 4)
    {
        ...
        if (elempack == 4)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                transpose4x4_epi16(_r0, _r1, _r2, _r3);
                __lsx_vstelm_d(_r0, pp, 0, 0);
                __lsx_vstelm_d(_r0, pp + 4, 0, 1);
                __lsx_vstelm_d(_r1, pp + 8, 0, 0);
                __lsx_vstelm_d(_r1, pp + 12, 0, 1);
                pp += 16;
                p0 += bottom_blob.cstep * 4;
            }
        }
    ...
    for (; jj + 15 < max_jj; jj += 16)
    {
        ...
        if (dy0 == dyf)
        {
            ...
            for (; kk < max_kk / elempack; kk++)
            {
                ...
                if (elempack == 8)
                {
                    __m128i _r0 = __lsx_vld(sptr, 0);
                    __m128i _r1 = __lsx_vld(sptr + stride_w * 8, 0);
                    __m128i _r2 = __lsx_vld(sptr + stride_w * 16, 0);
                    __m128i _r3 = __lsx_vld(sptr + stride_w * 24, 0);
                    __m128i _r4 = __lsx_vld(sptr + stride_w * 32, 0);
                    __m128i _r5 = __lsx_vld(sptr + stride_w * 40, 0);
                    __m128i _r6 = __lsx_vld(sptr + stride_w * 48, 0);
                    __m128i _r7 = __lsx_vld(sptr + stride_w * 56, 0);
                    __m128i _r8 = __lsx_vld(sptr + stride_w * 64, 0);
                    __m128i _r9 = __lsx_vld(sptr + stride_w * 72, 0);
                    __m128i _ra = __lsx_vld(sptr + stride_w * 80, 0);
                    __m128i _rb = __lsx_vld(sptr + stride_w * 88, 0);
                    __m128i _rc = __lsx_vld(sptr + stride_w * 96, 0);
                    __m128i _rd = __lsx_vld(sptr + stride_w * 104, 0);
                    __m128i _re = __lsx_vld(sptr + stride_w * 112, 0);
                    __m128i _rf = __lsx_vld(sptr + stride_w * 120, 0);
                    transpose8x8_epi16(_r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7);
                    transpose8x8_epi16(_r8, _r9, _ra, _rb, _rc, _rd, _re, _rf);
                    __lsx_vst(_r0, pp, 0);
                    __lsx_vst(_r8, pp + 8, 0);
        ...
        else
        {
            ...
            for (; kk < max_kk / elempack; kk++)
            {
                ...
                const unsigned short* sptrc = (const unsigned short*)img.row(yc) + xc * elempack;
                const unsigned short* sptrd = (const unsigned short*)img.row(yd) + xd * elempack;
                const unsigned short* sptre = (const unsigned short*)img.row(ye) + xe * elempack;
                const unsigned short* sptrf = (const unsigned short*)img.row(yf) + xf * elempack;
                ...
                if (elempack == 8)
                {
                    ...
                    __m128i _r4 = __lsx_vld(sptr4, 0);
                    __m128i _r5 = __lsx_vld(sptr5, 0);
                    __m128i _r6 = __lsx_vld(sptr6, 0);
                    __m128i _r7 = __lsx_vld(sptr7, 0);
                    __m128i _r8 = __lsx_vld(sptr8, 0);
                    __m128i _r9 = __lsx_vld(sptr9, 0);
                    __m128i _ra = __lsx_vld(sptra, 0);
                    __m128i _rb = __lsx_vld(sptrb, 0);
                    __m128i _rc = __lsx_vld(sptrc, 0);
                    __m128i _rd = __lsx_vld(sptrd, 0);
                    __m128i _re = __lsx_vld(sptre, 0);
                    __m128i _rf = __lsx_vld(sptrf, 0);
                    transpose8x8_epi16(_r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7);
                    transpose8x8_epi16(_r8, _r9, _ra, _rb, _rc, _rd, _re, _rf);
                    __lsx_vst(_r0, pp, 0);
                    __lsx_vst(_r8, pp + 8, 0);
    ...
    for (; jj + 7 < max_jj; jj += 8)
    {
        ...
        if (dy0 == dy7)
        {
            ...
            for (; kk < max_kk / elempack; kk++)
            {
                ...
                if (elempack == 8)
                {
                    __m128i _r0 = __lsx_vld(sptr + stride_w * 0, 0);
                    __m128i _r1 = __lsx_vld(sptr + stride_w * 8, 0);
                    __m128i _r2 = __lsx_vld(sptr + stride_w * 16, 0);
                    __m128i _r3 = __lsx_vld(sptr + stride_w * 24, 0);
                    __m128i _r4 = __lsx_vld(sptr + stride_w * 32, 0);
                    ...
                    __m128i _r7 = __lsx_vld(sptr + stride_w * 56, 0);
                    transpose8x8_epi16(_r0, _r1, _r2, _r3, _r4, _r5, _r6, _r7);
                    __lsx_vst(_r0, pp + 8 * 0, 0);
                    __lsx_vst(_r1, pp + 8 * 1, 0);
                    __lsx_vst(_r2, pp + 8 * 2, 0);
                    __lsx_vst(_r3, pp + 8 * 3, 0);
                    __lsx_vst(_r4, pp + 8 * 4, 0);
                    __lsx_vst(_r5, pp + 8 * 5, 0);
