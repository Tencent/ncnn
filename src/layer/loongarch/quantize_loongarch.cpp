...
static void quantize_bf16_pack4to8(const unsigned short* ptr0, const unsigned short* ptr1, signed char* s8ptr, const Mat& scale_data, int elemcount)
{
    ...
    {
        __m128i _v02_bf16 = __lsx_vld(ptr0, 0);
        __m128i _v13_bf16 = __lsx_vld(ptr1, 0);
        __m128 _v0 = (__m128)__lsx_vilvl_h(_v02_bf16, _zero);
        __m128 _v2 = (__m128)__lsx_vilvh_h(_v02_bf16, _zero);
        __m128 _v1 = (__m128)__lsx_vilvl_h(_v13_bf16, _zero);
        __m128 _v3 = (__m128)__lsx_vilvh_h(_v13_bf16, _zero);
        _v0 = __lsx_vfmul_s(_v0, _scale0);
        _v1 = __lsx_vfmul_s(_v1, _scale1);
...
static void quantize_bf16_pack4to1(const unsigned short* ptr, signed char* s8ptr0, signed char* s8ptr1, signed char* s8ptr2, signed char* s8ptr3, const Mat& scale_data, int elemcount)
{
    ...
    {
        __m128i _v01_bf16 = __lsx_vld(ptr, 0);
        __m128i _v23_bf16 = __lsx_vld(ptr + 8, 0);
        __m128i _v45_bf16 = __lsx_vld(ptr + 16, 0);
        __m128i _v67_bf16 = __lsx_vld(ptr + 24, 0);
        __m128 _v0 = (__m128)__lsx_vilvl_h(_v01_bf16, _zero);
        __m128 _v1 = (__m128)__lsx_vilvh_h(_v01_bf16, _zero);
        __m128 _v2 = (__m128)__lsx_vilvl_h(_v23_bf16, _zero);
        __m128 _v3 = (__m128)__lsx_vilvh_h(_v23_bf16, _zero);
        __m128 _v4 = (__m128)__lsx_vilvl_h(_v45_bf16, _zero);
        __m128 _v5 = (__m128)__lsx_vilvh_h(_v45_bf16, _zero);
        __m128 _v6 = (__m128)__lsx_vilvl_h(_v67_bf16, _zero);
        __m128 _v7 = (__m128)__lsx_vilvh_h(_v67_bf16, _zero);
        _v0 = __lsx_vfmul_s(_v0, _scale);
        _v1 = __lsx_vfmul_s(_v1, _scale);
