            ...
            if (elempack == 8)
            {
                for (; q + 7 < inh; q += 8)
                {
                    ...
                    for (int k = 0; k < kernel_w; k++)
                    {
                        ...
                        _sum2 = __lsx_vfmadd_s(_w4, (__m128)__lsx_vreplvei_w((__m128i)_r0, 2), _sum2);
                        _sum3 = __lsx_vfmadd_s(_w6, (__m128)__lsx_vreplvei_w((__m128i)_r0, 3), _sum3);
                        _sum0 = __lsx_vfmadd_s(_w8, (__m128)__lsx_vreplvei_w((__m128i)_r1, 0), _sum0);
                        _sum1 = __lsx_vfmadd_s(_wa, (__m128)__lsx_vreplvei_w((__m128i)_r1, 1), _sum1);
                        _sum2 = __lsx_vfmadd_s(_wc, (__m128)__lsx_vreplvei_w((__m128i)_r1, 2), _sum2);
                        _sum3 = __lsx_vfmadd_s(_we, (__m128)__lsx_vreplvei_w((__m128i)_r1, 3), _sum3);
                        _sum4 = __lsx_vfmadd_s(_w1, (__m128)__lsx_vreplvei_w((__m128i)_r0, 0), _sum4);
                        _sum5 = __lsx_vfmadd_s(_w3, (__m128)__lsx_vreplvei_w((__m128i)_r0, 1), _sum5);
                        _sum6 = __lsx_vfmadd_s(_w5, (__m128)__lsx_vreplvei_w((__m128i)_r0, 2), _sum6);
                        _sum7 = __lsx_vfmadd_s(_w7, (__m128)__lsx_vreplvei_w((__m128i)_r0, 3), _sum7);
                        _sum4 = __lsx_vfmadd_s(_w9, (__m128)__lsx_vreplvei_w((__m128i)_r1, 0), _sum4);
                        _sum5 = __lsx_vfmadd_s(_wb, (__m128)__lsx_vreplvei_w((__m128i)_r1, 1), _sum5);
                        _sum6 = __lsx_vfmadd_s(_wd, (__m128)__lsx_vreplvei_w((__m128i)_r1, 2), _sum6);
                        _sum7 = __lsx_vfmadd_s(_wf, (__m128)__lsx_vreplvei_w((__m128i)_r1, 3), _sum7);
            ...
            for (; q + 3 < inh; q += 4)
            {
                ...
                if (elempack == 4)
                {
                    for (int k = 0; k < kernel_w; k++)
                    {
                        ...
                        _sum2 = __lsx_vfmadd_s(_w4, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[2])), _sum2);
                        _sum3 = __lsx_vfmadd_s(_w6, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[3])), _sum3);
                        _sum4 = __lsx_vfmadd_s(_w1, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[0])), _sum4);
                        _sum5 = __lsx_vfmadd_s(_w3, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[1])), _sum5);
                        _sum6 = __lsx_vfmadd_s(_w5, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[2])), _sum6);
                        _sum7 = __lsx_vfmadd_s(_w7, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[3])), _sum7);
                ...
                if (elempack == 1)
                {
                    for (int k = 0; k < kernel_w; k++)
                    {
                        ...
                        _sum2 = __lsx_vfmadd_s(_w4, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[N * 2])), _sum2);
                        _sum3 = __lsx_vfmadd_s(_w6, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[N * 3])), _sum3);
                        _sum4 = __lsx_vfmadd_s(_w1, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[0])), _sum4);
                        _sum5 = __lsx_vfmadd_s(_w3, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[N])), _sum5);
                        _sum6 = __lsx_vfmadd_s(_w5, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[N * 2])), _sum6);
                        _sum7 = __lsx_vfmadd_s(_w7, (__m128)__lsx_vreplfr2vr_s(bfloat16_to_float32(r0[N * 3])), _sum7);
            ...
            for (; q + 7 < inh; q += 8)
            {
                ...
                if (elempack == 8)
                {
                    for (int k = 0; k < kernel_w; k++)
                    {
                        ...
                        _sum2 = __lsx_vfmadd_s(_w2, (__m128)__lsx_vreplvei_w((__m128i)_r0, 2), _sum2);
                        _sum3 = __lsx_vfmadd_s(_w3, (__m128)__lsx_vreplvei_w((__m128i)_r0, 3), _sum3);
                        _sum0 = __lsx_vfmadd_s(_w4, (__m128)__lsx_vreplvei_w((__m128i)_r1, 0), _sum0);
                        _sum1 = __lsx_vfmadd_s(_w5, (__m128)__lsx_vreplvei_w((__m128i)_r1, 1), _sum1);
                        _sum2 = __lsx_vfmadd_s(_w6, (__m128)__lsx_vreplvei_w((__m128i)_r1, 2), _sum2);
                        _sum3 = __lsx_vfmadd_s(_w7, (__m128)__lsx_vreplvei_w((__m128i)_r1, 3), _sum3);
