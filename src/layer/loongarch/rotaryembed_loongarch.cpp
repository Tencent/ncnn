    ...
    for (int q = 0; q < num_heads; q++)
    {
        ...
        for (int i = 0; i < seqlen; i++)
        {
            if (interleaved)
            {
                ...
                {
                    __m256 _a0 = (__m256)__lasx_xvld(ptr, 0);
                    __m256 _a1 = (__m256)__lasx_xvld(ptr + 8, 0);

                    __m256 _c8 = (__m256)__lasx_xvld(cos_ptr, 0);
                    __m256 _s8 = (__m256)__lasx_xvld(sin_ptr, 0);
                    ...
                    __lasx_xvst(_y0, outptr, 0);
                    __lasx_xvst(_y1, outptr + 8, 0);
                ...
                for (; j + 3 < embed_dim / 2; j += 4)
                {
                    ...
                    __m128 _a1 = (__m128)__lsx_vld(ptr + 4, 0);

                    __m128 _c4 = (__m128)__lsx_vld(cos_ptr, 0);
                    __m128 _s4 = (__m128)__lsx_vld(sin_ptr, 0);
                    ...
                    __lsx_vst(_y0, outptr, 0);
                    __lsx_vst(_y1, outptr + 4, 0);
