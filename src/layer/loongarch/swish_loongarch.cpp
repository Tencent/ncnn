    ...
    for (int q = 0; q < channels; q++)
    {
...
#else  // __loongarch_asx
        {
            ...
            for (; i + 7 < size; i += 8)
            {
                ...
                _p0 = __lsx_vfdiv_s(_p0, __lsx_vfadd_s(_one, exp_ps((__m128)__lsx_vbitrevi_w((__m128i)_p0, 31))));
                _p1 = __lsx_vfdiv_s(_p1, __lsx_vfadd_s(_one, exp_ps((__m128)__lsx_vbitrevi_w((__m128i)_p1, 31))));
