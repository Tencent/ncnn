...
static void padding_constant_pack8_bf16s_lsx(const Mat& src, Mat& dst, int top, int bottom, int left, int right, const __m128i& v)
{
...
static void padding_replicate_pack8_bf16s_lsx(const Mat& src, Mat& dst, int top, int bottom, int left, int right)
{
    const unsigned short* ptr = src;
    unsigned short* outptr = dst;
...
static void padding_reflect_pack8_bf16s_lsx(const Mat& src, Mat& dst, int top, int bottom, int left, int right)
{
    const unsigned short* ptr = src;
    unsigned short* outptr = dst;
