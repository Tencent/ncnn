...
#include "yolov3detectionoutput_loongarch.h"

namespace ncnn {

Yolov3DetectionOutput_loongarch::Yolov3DetectionOutput_loongarch()
{
...
int Yolov3DetectionOutput_loongarch::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
