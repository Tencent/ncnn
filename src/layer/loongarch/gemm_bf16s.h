    ...
    for (; ii < max_ii; ii += 1)
    {
        ...
        for (; jj + 15 < max_jj; jj += 16)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                _pA0 = (__m256)__lasx_xvreplgr2vr_w((int)((unsigned int)pA[1] << 16));
                _sum1 = __lasx_xvfmadd_s(_pA0, _pB0, _sum1);
                _sum9 = __lasx_xvfmadd_s(_pA0, _pB1, _sum9);

                _pB0 = bfloat2float_lasx((__m128i)__lsx_vld(pB + 32, 0));
                _pB1 = bfloat2float_lasx((__m128i)__lsx_vld(pB + 40, 0));
                _pA0 = (__m256)__lasx_xvreplgr2vr_w((int)((unsigned int)pA[2] << 16));
                _sum2 = __lasx_xvfmadd_s(_pA0, _pB0, _sum2);
                _suma = __lasx_xvfmadd_s(_pA0, _pB1, _suma);

                _pB0 = bfloat2float_lasx((__m128i)__lsx_vld(pB + 48, 0));
                _pB1 = bfloat2float_lasx((__m128i)__lsx_vld(pB + 56, 0));
                _pA0 = (__m256)__lasx_xvreplgr2vr_w((int)((unsigned int)pA[3] << 16));
                _sum3 = __lasx_xvfmadd_s(_pA0, _pB0, _sum3);
                _sumb = __lasx_xvfmadd_s(_pA0, _pB1, _sumb);
        ...
        for (; jj + 7 < max_jj; jj += 8)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                _pA0 = (__m128)__lsx_vreplgr2vr_w((int)((unsigned int)pA[1] << 16));
                _sum1 = __lsx_vfmadd_s(_pA0, _pB0, _sum1);
                _sum9 = __lsx_vfmadd_s(_pA0, _pB1, _sum9);

                _pB01_bf16 = __lsx_vld(pB + 16, 0);
                _pB0 = (__m128)__lsx_vilvl_h(_pB01_bf16, _zero_bf16);
                _pB1 = (__m128)__lsx_vilvh_h(_pB01_bf16, _zero_bf16);
                _pA0 = (__m128)__lsx_vreplgr2vr_w((int)((unsigned int)pA[2] << 16));
                _sum2 = __lsx_vfmadd_s(_pA0, _pB0, _sum2);
                _suma = __lsx_vfmadd_s(_pA0, _pB1, _suma);

                _pB01_bf16 = __lsx_vld(pB + 24, 0);
                _pB0 = (__m128)__lsx_vilvl_h(_pB01_bf16, _zero_bf16);
                _pB1 = (__m128)__lsx_vilvh_h(_pB01_bf16, _zero_bf16);
                _pA0 = (__m128)__lsx_vreplgr2vr_w((int)((unsigned int)pA[3] << 16));
                _sum3 = __lsx_vfmadd_s(_pA0, _pB0, _sum3);
                _sumb = __lsx_vfmadd_s(_pA0, _pB1, _sumb);
        ...
        for (; jj + 3 < max_jj; jj += 4)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                _pA = (__m128)__lsx_vreplgr2vr_w((int)((unsigned int)pA[1] << 16));
                _pB = bfloat2float_lsx(__lsx_vldrepl_d(pB + 4, 0));
                _sum1 = __lsx_vfmadd_s(_pA, _pB, _sum1);

                _pA = (__m128)__lsx_vreplgr2vr_w((int)((unsigned int)pA[2] << 16));
                _pB = bfloat2float_lsx(__lsx_vldrepl_d(pB + 8, 0));
                _sum2 = __lsx_vfmadd_s(_pA, _pB, _sum2);

                _pA = (__m128)__lsx_vreplgr2vr_w((int)((unsigned int)pA[3] << 16));
                _pB = bfloat2float_lsx(__lsx_vldrepl_d(pB + 12, 0));
                _sum3 = __lsx_vfmadd_s(_pA, _pB, _sum3);
...
static int gemm_BT_loongarch_m1_bf16s(const Mat& A, const Mat& BT, const Mat& C, Mat& top_blob, int broadcast_type_C, int N, int K, float alpha, float beta, int constant_TILE_M, int constant_TILE_N, int constant_TILE_K, int nT, int output_elemtype, const Option& opt)
{
    (void)opt;
    ...
    int TILE_N;
    int TILE_K;
    get_optimal_tile_mnk_bf16(0, N, K, constant_TILE_M, constant_TILE_N, constant_TILE_K, TILE_M, TILE_N, TILE_K, nT);
    ...
    for (int ppj = 0; ppj < nn_N; ppj++)
    {
        ...
        float* outptr0f = outptrf + j;
        unsigned short* outptr0 = outptr + j;
        ...
        for (; jj + 15 < max_jj; jj += 16)
        {
            ...
            __m256 _sum8 = (__m256)__lasx_xvreplgr2vr_w(0);
            ...
            for (int ppk = 0; ppk < nn_K; ppk++)
            {
                ...
                const unsigned short* pA = pA0 + k;
                const unsigned short* pB = BT_tile.row<const unsigned short>(ppk) + jj * max_kk;
            ...
            if (pC0)
            {
                ...
                {
                    __m256 _c = __lasx_xvfmul_s((__m256)__lasx_xvreplfr2vr_s(pC0[0]), _beta);
                    _sum0 = __lasx_xvfadd_s(_sum0, _c);
                    _sum8 = __lasx_xvfadd_s(_sum8, _c);
                }
                if (broadcast_type_C == 3 || broadcast_type_C == 4)
                {
                    _sum0 = __lasx_xvfmadd_s(_beta, (__m256)__lasx_xvld(pC0 + jj, 0), _sum0);
                    _sum8 = __lasx_xvfmadd_s(_beta, (__m256)__lasx_xvld(pC0 + jj + 8, 0), _sum8);
                }
            }
            if (alpha != 1.f)
            {
                ...
                _sum8 = __lasx_xvfmul_s(_sum8, _alpha);
            }

            if (output_elemtype == 1)
            {
                __lasx_xvst(_sum0, outptr0f + jj, 0);
                __lasx_xvst(_sum8, outptr0f + jj + 8, 0);
            }
            else
            {
                __lasx_xvst(__lasx_concat_128(float2bfloat_lasx(_sum0), float2bfloat_lasx(_sum8)), outptr0 + jj, 0);
            }
        }
#endif // __loongarch_asx
        for (; jj + 7 < max_jj; jj += 8)
        {
            ...
            if (pC0)
            {
                ...
                if (broadcast_type_C == 3 || broadcast_type_C == 4)
                {
                    _sum0 = __lsx_vfmadd_s(_beta, (__m128)__lsx_vld(pC0 + jj, 0), _sum0);
                    _sum8 = __lsx_vfmadd_s(_beta, (__m128)__lsx_vld(pC0 + jj + 4, 0), _sum8);
                }
            }
            if (alpha != 1.f)
            {
                __m128 _alpha = __lsx_vreplfr2vr_s(alpha);
                _sum0 = __lsx_vfmul_s(_sum0, _alpha);
                _sum8 = __lsx_vfmul_s(_sum8, _alpha);
            }

            if (output_elemtype == 1)
            {
                __lsx_vst((__m128i)_sum0, outptr0f + jj, 0);
                __lsx_vst((__m128i)_sum8, outptr0f + jj + 4, 0);
            }
            else
            {
                __lsx_vst(float2bfloat_lsx(_sum0, _sum8), outptr0 + jj, 0);
            }
        }
        ...
        for (; jj + 3 < max_jj; jj += 4)
        {
            ...
            if (alpha != 1.f)
                _sum0 = __lsx_vfmul_s(_sum0, __lsx_vreplfr2vr_s(alpha));

            if (output_elemtype == 1)
                __lsx_vst((__m128i)_sum0, outptr0f + jj, 0);
            else
                __lsx_vstelm_d(float2bfloat_lsx(_sum0), outptr0 + jj, 0, 0);
        }
#endif // __loongarch_sx
        ...
        for (; jj + 1 < max_jj; jj += 2)
        {
            ...
            {
                outptr0[jj] = float32_to_bfloat16(sum0);
                outptr0[jj + 1] = float32_to_bfloat16(sum1);
            }
        }
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            if (output_elemtype == 1)
                ...
                outptr0[jj] = float32_to_bfloat16(sum);
        }
    }
