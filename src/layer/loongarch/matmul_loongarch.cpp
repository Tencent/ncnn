...
#include "matmul_loongarch.h"

#include "layer_type.h"

namespace ncnn {

MatMul_loongarch::MatMul_loongarch()
{
    gemm = 0;
}

int MatMul_loongarch::create_pipeline(const Option& opt)
{
...
int MatMul_loongarch::destroy_pipeline(const Option& opt)
{
    if (gemm)
    {
...
int MatMul_loongarch::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
