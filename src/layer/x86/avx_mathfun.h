...
/* natural logarithm computed for 8 simultaneous float
   return NaN for x <= 0
*/
static forceinline __m256 log256_ps(__m256 x)
{
    __m256i imm0;
...
static forceinline __m256 exp256_ps(__m256 x)
{
...
*/
static forceinline __m256 sin256_ps(__m256 x)
{   // any x
...
static forceinline __m256 cos256_ps(__m256 x)
{   // any x
...
static forceinline void sincos256_ps(__m256 x, __m256* s, __m256* c)
{
...
static forceinline __m256 pow_ps(__m256 a, __m256 b)
{
    // pow(x, m) = exp(m * log(x))
