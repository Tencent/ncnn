...
{   // any x
    ...
    */
    ...
    imm2 = avx2_mm256_add_epi32(imm2, *(__m256i*)_pi32_256_1);
    imm2 = avx2_mm256_and_si256(imm2, *(__m256i*)_pi32_256_inv1);
    y = _mm256_cvtepi32_ps(imm2);

    /* get the swap sign flag */
    imm0 = avx2_mm256_and_si256(imm2, *(__m256i*)_pi32_256_4);
    ...
    */
    imm2 = avx2_mm256_and_si256(imm2, *(__m256i*)_pi32_256_2);
    imm2 = avx2_mm256_cmpeq_epi32(imm2, *(__m256i*)_pi32_256_0);
#else
...
{   // any x
    ...
    imm2 = avx2_mm256_and_si256(imm2, *(__m256i*)_pi32_256_inv1);
    y = _mm256_cvtepi32_ps(imm2);
    imm2 = avx2_mm256_sub_epi32(imm2, *(__m256i*)_pi32_256_2);

    /* get the swap sign flag */
    imm0 = avx2_mm256_andnot_si256(imm2, *(__m256i*)_pi32_256_4);
    imm0 = avx2_mm256_slli_epi32(imm0, 29);
    /* get the polynom selection mask */
    imm2 = avx2_mm256_and_si256(imm2, *(__m256i*)_pi32_256_2);
    imm2 = avx2_mm256_cmpeq_epi32(imm2, *(__m256i*)_pi32_256_0);
...
#ifdef __AVX2__
    imm4 = avx2_mm256_sub_epi32(imm4, *(__m256i*)_pi32_256_2);
    imm4 = avx2_mm256_andnot_si256(imm4, *(__m256i*)_pi32_256_4);
