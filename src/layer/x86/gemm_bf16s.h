    ...
    for (; ii < max_ii; ii++)
    {
        ...
        for (; jj + 7 < max_jj; jj += 8)
        {
            ...
            for (; kk + 3 < max_kk; kk += 4)
            {
                ...
                __m128 _pA1 = _mm_set1_ps(bfloat16_to_float32(pA[1]));
                ...
                __m128 _pA2 = _mm_set1_ps(bfloat16_to_float32(pA[2]));
                ...
                __m128 _pA3 = _mm_set1_ps(bfloat16_to_float32(pA[3]));
