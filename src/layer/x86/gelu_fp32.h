...
static void gelu_fp32(Mat& bottom_top_blob, int fast_gelu, const Option& opt)
{
#if NCNN_RUNTIME_CPU && NCNN_FMA && __AVX__ && !__FMA__ && !__FMA4__
    if (ncnn::cpu_support_x86_fma())
    {
        gelu_fp32_fma(bottom_top_blob, fast_gelu, opt);
        return;
    }
#endif
#if NCNN_RUNTIME_CPU && NCNN_FMA4 && __AVX__ && !__FMA__ && !__FMA4__
    ...
    {
        gelu_fp32_fma4(bottom_top_blob, fast_gelu, opt);
        return;
    }
#endif
