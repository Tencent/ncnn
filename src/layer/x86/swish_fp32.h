...
void swish_fp32_fma4(Mat& bottom_top_blob, const Option& opt);
#endif

static void swish_fp32(Mat& bottom_top_blob, const Option& opt)
{
#if NCNN_RUNTIME_CPU && NCNN_FMA && __AVX__ && !__FMA__ && !__FMA4__
    if (ncnn::cpu_support_x86_fma())
    {
        swish_fp32_fma(bottom_top_blob, opt);
        return;
    }
#endif
#if NCNN_RUNTIME_CPU && NCNN_FMA4 && __AVX__ && !__FMA__ && !__FMA4__
    ...
    {
        swish_fp32_fma4(bottom_top_blob, opt);
        return;
    }
#endif
