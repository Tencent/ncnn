...
void rmsnorm_fma(float* ptr, const float* gamma_ptr, float eps, int elemcount, int elempack);
#endif
#if NCNN_RUNTIME_CPU && NCNN_FMA4 && __AVX__ && !__FMA__ && !__FMA4__
void rmsnorm_fma4(float* ptr, const float* gamma_ptr, float eps, int elemcount, int elempack);
#endif
...
static void rmsnorm(float* ptr, const float* gamma_ptr, float eps, int elemcount, int elempack)
{
    ...
    {
        rmsnorm_fma(ptr, gamma_ptr, eps, elemcount, elempack);
        return;
    }
#endif
#if NCNN_RUNTIME_CPU && NCNN_FMA4 && __AVX__ && !__FMA__ && !__FMA4__
    ...
    {
        rmsnorm_fma4(ptr, gamma_ptr, eps, elemcount, elempack);
        return;
    }
#endif
