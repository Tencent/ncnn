                        ...
                        for (int ic = 0; ic < inch; ic++)
                        {
                            ...
                            for (int ez = 0; ez < elempack; ez++)
                            {
                                ...
                                if (out_elempack == 16)
                                {
                                    ...
                                    _sum_avx512 = _mm512_fmadd_ps(_mm512_set1_ps(val), _conv_w, _sum_avx512);
                                    kptr += 16;
                                }
#endif // __AVX512F__
                                if (out_elempack == 8)
                                {
                                    ...
                                    _sum_avx = _mm256_comp_fmadd_ps(_mm256_set1_ps(val), _conv_w, _sum_avx);
                                    kptr += 8;
                                }
#endif // __AVX__
                                if (out_elempack == 4)
                                {
                                    ...
                                    _sum_sse = _mm_comp_fmadd_ps(_mm_set1_ps(val), _conv_w, _sum_sse);
                                    kptr += 4;
                                }
#endif // __SSE2__
                                if (out_elempack == 1)
