...
void convolution_gemm_transB_packed_tile_fma4(const Mat& AT_tile, const Mat& BT_tile, const Mat& CT_tile, Mat& topT_tile, Mat& top_blob, int i, int max_ii, int j, int max_jj, int k, int max_kk, bool k_end)
{
...
void conv2x2s1_pack8_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
    conv2x2s1_pack8_avx(bottom_blob, top_blob, kernel, bias, opt);
}

void conv3x3s1_pack8_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
...
void conv3x3s1_pack8to1_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
