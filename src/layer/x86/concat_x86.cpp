...
int Concat_x86::forward_bf16s_fp16s(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
    int dims = bottom_blobs[0].dims;
    int positive_axis = axis < 0 ? dims + axis : axis;
        ...
        for (size_t b = 0; b < bottom_blobs.size(); b++)
        {
            ...
            if (bottom_blob.elempack == 16 && elempack == 8)
            {
                for (int i = 0; i < bottom_blob.h; i++)
                {
                    ...
                    unsigned short* outptr1 = outptr + w * 8;
            ...
            if (bottom_blob.elempack == 16 && elempack == 4)
            {
                for (int i = 0; i < bottom_blob.h; i++)
                {
                    ...
                    unsigned short* outptr2 = outptr + w * 8;
                    unsigned short* outptr3 = outptr + w * 12;
            ...
            if (bottom_blob.elempack == 16 && elempack == 1)
            {
                for (int i = 0; i < bottom_blob.h; i++)
                {
                    ...
                    unsigned short* outptr8 = outptr + w * 8;
                    unsigned short* outptr9 = outptr + w * 9;
                    unsigned short* outptra = outptr + w * 10;
                    unsigned short* outptrb = outptr + w * 11;
                    unsigned short* outptrc = outptr + w * 12;
                    unsigned short* outptrd = outptr + w * 13;
                    unsigned short* outptre = outptr + w * 14;
                    unsigned short* outptrf = outptr + w * 15;
        ...
        for (size_t b = 0; b < bottom_blobs.size(); b++)
        {
            ...
            if (bottom_blob.elempack == 16 && elempack == 1)
            {
                ...
                for (int q = 0; q < bottom_blob.c; q++)
                {
                    ...
                    unsigned short* outptr8 = top_blob_unpacked.channel(p + 8);
                    unsigned short* outptr9 = top_blob_unpacked.channel(p + 9);
                    unsigned short* outptra = top_blob_unpacked.channel(p + 10);
                    unsigned short* outptrb = top_blob_unpacked.channel(p + 11);
                    unsigned short* outptrc = top_blob_unpacked.channel(p + 12);
                    unsigned short* outptrd = top_blob_unpacked.channel(p + 13);
                    unsigned short* outptre = top_blob_unpacked.channel(p + 14);
                    unsigned short* outptrf = top_blob_unpacked.channel(p + 15);
