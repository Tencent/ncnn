...
void mish_bf16s_avxneconvert(Mat& a, const Option& opt);
#endif

#if NCNN_RUNTIME_CPU && NCNN_AVX2 && __AVX__ && !__AVX2__ && !__AVX512BF16__
void mish_bf16s_avx2(Mat& a, const Option& opt);
#endif
...
void mish_bf16s_fma4(Mat& a, const Option& opt);
#endif
