            ...
            for (int g = 0; g < block_count; g++)
            {
                ...
                if (elempack == 8)
                {
                    ...
                    for (int kk = 0; kk < max_kk0; kk++)
                    {
                        ...
                        __m256 _p1 = bfloat2float_avx(_mm_loadu_si128((const __m128i*)(p0a + A_hstep * 8)));
                    ...
                    for (; kk + 3 < max_kk0; kk += 4)
                    {
                        __m512 _p0 = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)(p0 + 0 * 8)), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8 + 0 * 8))));
                        __m512 _p1 = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)(p0 + 1 * 8)), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8 + 1 * 8))));
                        __m512 _p2 = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)(p0 + 2 * 8)), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8 + 2 * 8))));
                        __m512 _p3 = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)(p0 + 3 * 8)), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8 + 3 * 8))));
                    ...
                    for (; kk + 1 < max_kk0; kk += 2)
                    {
                        __m512 _p0 = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)p0), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8))));
                        __m512 _p1 = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)(p0 + 8)), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8 + 8))));
                        __m128i _q0 = float2int8_avx512(_mm512_mul_ps(_p0, _scale));
                        __m128i _q1 = float2int8_avx512(_mm512_mul_ps(_p1, _scale));
                        _mm_storeu_si128((__m128i*)pp, _mm_unpacklo_epi8(_q0, _q1));
                        _mm_storeu_si128((__m128i*)(pp + 16), _mm_unpackhi_epi8(_q0, _q1));
                    ...
                    for (; kk < max_kk0; kk++)
                    {
                        __m512 _p = bfloat2float_avx512(combine4x2_epi32(_mm_loadu_si128((const __m128i*)p0), _mm_loadu_si128((const __m128i*)(p0 + A_hstep * 8))));
                        _mm_storeu_si128((__m128i*)pp, float2int8_avx512(_mm512_mul_ps(_p, _scale)));
                        pp += 16;
                        p0 += 8;
                    }
                ...
                if (elempack == 4)
                {
                    ...
                    for (int kk = 0; kk < max_kk0; kk++)
                    {
                        ...
                        __m128 _p1 = bfloat2float_sse(_mm_loadl_epi64((const __m128i*)(p0a + A_hstep * 4)));
                        __m128 _p2 = bfloat2float_sse(_mm_loadl_epi64((const __m128i*)(p0a + A_hstep * 8)));
                        __m128 _p3 = bfloat2float_sse(_mm_loadl_epi64((const __m128i*)(p0a + A_hstep * 12)));
                    ...
                    for (; kk + 3 < max_kk0; kk += 4)
                    {
                        __m128i _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + 0 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4 + 0 * 4)));
                        __m128i _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8 + 0 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12 + 0 * 4)));
                        __m512 _p0 = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + 1 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4 + 1 * 4)));
                        _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8 + 1 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12 + 1 * 4)));
                        __m512 _p1 = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + 2 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4 + 2 * 4)));
                        _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8 + 2 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12 + 2 * 4)));
                        __m512 _p2 = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + 3 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4 + 3 * 4)));
                        _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8 + 3 * 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12 + 3 * 4)));
                        __m512 _p3 = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        __m128i _q0 = float2int8_avx512(_mm512_mul_ps(_p0, _scale));
                        __m128i _q1 = float2int8_avx512(_mm512_mul_ps(_p1, _scale));
                        __m128i _q2 = float2int8_avx512(_mm512_mul_ps(_p2, _scale));
                        __m128i _q3 = float2int8_avx512(_mm512_mul_ps(_p3, _scale));
                    ...
                    for (; kk + 1 < max_kk0; kk += 2)
                    {
                        __m128i _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)p0), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4)));
                        __m128i _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12)));
                        __m512 _p0 = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4 + 4)));
                        _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8 + 4)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12 + 4)));
                        __m512 _p1 = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        __m128i _q0 = float2int8_avx512(_mm512_mul_ps(_p0, _scale));
                        __m128i _q1 = float2int8_avx512(_mm512_mul_ps(_p1, _scale));
                        _mm_storeu_si128((__m128i*)pp, _mm_unpacklo_epi8(_q0, _q1));
                    ...
                    for (; kk < max_kk0; kk++)
                    {
                        __m128i _r0 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)p0), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4)));
                        __m128i _r1 = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 8)), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 12)));
                        __m512 _p = bfloat2float_avx512(combine4x2_epi32(_r0, _r1));
                        _mm_storeu_si128((__m128i*)pp, float2int8_avx512(_mm512_mul_ps(_p, _scale)));
                        pp += 16;
                        p0 += 4;
                    }
                ...
                if (elempack == 1)
                {
                    ...
                    {
                        {
                            ...
                            __m512 _t0 = bfloat2float_avx512(combine4x2_epi32(_p0, _p8));
                            __m512 _t1 = bfloat2float_avx512(combine4x2_epi32(_p1, _p9));
                            __m512 _t2 = bfloat2float_avx512(combine4x2_epi32(_p2, _pa));
                            __m512 _t3 = bfloat2float_avx512(combine4x2_epi32(_p3, _pb));
                            ...
                            _t0 = bfloat2float_avx512(combine4x2_epi32(_p4, _pc));
                            _t1 = bfloat2float_avx512(combine4x2_epi32(_p5, _pd));
                            _t2 = bfloat2float_avx512(combine4x2_epi32(_p6, _pe));
                            _t3 = bfloat2float_avx512(combine4x2_epi32(_p7, _pf));
                    ...
                    for (; kk + 1 < max_kk0; kk += 2)
                    {
                        __m512i _r0 = _mm512_i32gather_epi32(_vindex, (const int*)p0, sizeof(unsigned short));
                        __m512i _r1 = _mm512_i32gather_epi32(_vindex, (const int*)(p0 + 1), sizeof(unsigned short));
                        __m512 _p0 = bfloat2float_avx512(_mm512_cvtepi32_epi16(_r0));
                        __m512 _p1 = bfloat2float_avx512(_mm512_cvtepi32_epi16(_r1));
                        __m128i _q0 = float2int8_avx512(_mm512_mul_ps(_p0, _scale));
                        __m128i _q1 = float2int8_avx512(_mm512_mul_ps(_p1, _scale));
                        _mm_storeu_si128((__m128i*)pp, _mm_unpacklo_epi8(_q0, _q1));
                        _mm_storeu_si128((__m128i*)(pp + 16), _mm_unpackhi_epi8(_q0, _q1));
                    ...
                    for (; kk < max_kk0; kk++)
                    {
                        __m512i _r = _mm512_i32gather_epi32(_vindex, (const int*)p0, sizeof(unsigned short));
                        __m512 _p = bfloat2float_avx512(_mm512_cvtepi32_epi16(_r));
                        _mm_storeu_si128((__m128i*)pp, float2int8_avx512(_mm512_mul_ps(_p, _scale)));
                        pp += 16;
                        p0++;
                    }
        ...
        for (; ii + 7 < max_ii; ii += 8)
        {
            ...
            for (int g = 0; g < block_count; g++)
            {
                ...
                if (elempack == 4)
                {
                    ...
                    for (; kk < max_kk0; kk++)
                    {
                        __m128i _r = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)p0a), _mm_loadl_epi64((const __m128i*)(p0a + A_hstep * 4)));
                        __m256 _p = bfloat2float_avx(_r);
                        _absmax = _mm256_max_ps(_absmax, abs256_ps(_p));
                        p0a += 4;
                    }
                    ...
                    for (; kk < max_kk0; kk++)
                    {
                        __m128i _r = _mm_unpacklo_epi64(_mm_loadl_epi64((const __m128i*)p0), _mm_loadl_epi64((const __m128i*)(p0 + A_hstep * 4)));
                        __m256 _p = bfloat2float_avx(_r);
                ...
                if (elempack == 1)
                {
                    ...
                    {
#if __AVX2__
                        __m256i _r = _mm256_i32gather_epi32((const int*)p0a, _vindex, sizeof(unsigned short));
                        __m256 _p = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r));
#else
                    ...
                    {
#if __AVX2__
                        __m256i _r0 = _mm256_i32gather_epi32((const int*)p0, _vindex, sizeof(unsigned short));
                        __m256i _r1 = _mm256_i32gather_epi32((const int*)(p0 + 1), _vindex, sizeof(unsigned short));
                        __m256 _p0 = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r0));
                        __m256 _p1 = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r1));
#else
                    ...
                    {
#if __AVX2__
                        __m256i _r = _mm256_i32gather_epi32((const int*)p0, _vindex, sizeof(unsigned short));
                        __m256 _p = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r));
#else
        ...
        for (; ii + 3 < max_ii; ii += 4)
        {
            ...
            for (int g = 0; g < block_count; g++)
            {
                ...
                if (elempack == 1)
                {
                    ...
                    {
#if __AVX2__
                        __m128i _r = _mm_i32gather_epi32((const int*)p0a, _vindex, sizeof(unsigned short));
                        __m128 _p = bfloat2float_sse(_mm_comp_cvtepi32_epi16(_r));
#else
                    ...
                    {
#if __AVX2__
                        __m128i _r0 = _mm_i32gather_epi32((const int*)p0, _vindex, sizeof(unsigned short));
                        __m128i _r1 = _mm_i32gather_epi32((const int*)(p0 + 1), _vindex, sizeof(unsigned short));
                        __m128 _p0 = bfloat2float_sse(_mm_comp_cvtepi32_epi16(_r0));
                        __m128 _p1 = bfloat2float_sse(_mm_comp_cvtepi32_epi16(_r1));
#else
                        __m128 _p0 = _mm_setr_ps(bfloat16_to_float32(p0[0]), bfloat16_to_float32(p0[A_hstep]), bfloat16_to_float32(p0[A_hstep * 2]), bfloat16_to_float32(p0[A_hstep * 3]));
                    ...
                    {
#if __AVX2__
                        __m128i _r = _mm_i32gather_epi32((const int*)p0, _vindex, sizeof(unsigned short));
                        __m128 _p = bfloat2float_sse(_mm_comp_cvtepi32_epi16(_r));
#else
                ...
                {
                    {
                        ...
                        __m512 _t0 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p0, _p8)), _mm512_set1_ps(ps[0]));
                        __m512 _t1 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p1, _p9)), _mm512_set1_ps(ps[1]));
                        __m512 _t2 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p2, _pa)), _mm512_set1_ps(ps[2]));
                        __m512 _t3 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p3, _pb)), _mm512_set1_ps(ps[3]));
                        __m128i _q0 = float2int8_avx512(_mm512_mul_ps(_t0, _scale));
                        __m128i _q1 = float2int8_avx512(_mm512_mul_ps(_t1, _scale));
                        __m128i _q2 = float2int8_avx512(_mm512_mul_ps(_t2, _scale));
                        __m128i _q3 = float2int8_avx512(_mm512_mul_ps(_t3, _scale));
                        ...
                        _t0 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p4, _pc)), _mm512_set1_ps(ps[4]));
                        _t1 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p5, _pd)), _mm512_set1_ps(ps[5]));
                        _t2 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p6, _pe)), _mm512_set1_ps(ps[6]));
                        _t3 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p7, _pf)), _mm512_set1_ps(ps[7]));
                        _q0 = float2int8_avx512(_mm512_mul_ps(_t0, _scale));
                        _q1 = float2int8_avx512(_mm512_mul_ps(_t1, _scale));
                        _q2 = float2int8_avx512(_mm512_mul_ps(_t2, _scale));
                        _q3 = float2int8_avx512(_mm512_mul_ps(_t3, _scale));
                    ...
                    }
                    {
                        ...
                        __m512 _t0 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p0, _p8)), _mm512_set1_ps(ps[8]));
                        __m512 _t1 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p1, _p9)), _mm512_set1_ps(ps[9]));
                        __m512 _t2 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p2, _pa)), _mm512_set1_ps(ps[10]));
                        __m512 _t3 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p3, _pb)), _mm512_set1_ps(ps[11]));
                        __m128i _q0 = float2int8_avx512(_mm512_mul_ps(_t0, _scale));
                        __m128i _q1 = float2int8_avx512(_mm512_mul_ps(_t1, _scale));
                        __m128i _q2 = float2int8_avx512(_mm512_mul_ps(_t2, _scale));
                        __m128i _q3 = float2int8_avx512(_mm512_mul_ps(_t3, _scale));
                        ...
                        _t0 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p4, _pc)), _mm512_set1_ps(ps[12]));
                        _t1 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p5, _pd)), _mm512_set1_ps(ps[13]));
                        _t2 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p6, _pe)), _mm512_set1_ps(ps[14]));
                        _t3 = _mm512_mul_ps(bfloat2float_avx512(combine4x2_epi32(_p7, _pf)), _mm512_set1_ps(ps[15]));
                        _q0 = float2int8_avx512(_mm512_mul_ps(_t0, _scale));
                        _q1 = float2int8_avx512(_mm512_mul_ps(_t1, _scale));
                        _q2 = float2int8_avx512(_mm512_mul_ps(_t2, _scale));
                        _q3 = float2int8_avx512(_mm512_mul_ps(_t3, _scale));
...
static void transpose_quantize_A_tile_wq_int8_bf16s(const Mat& A, Mat& AT_tile, Mat& AT_descales_tile, int i, int max_ii, int k, int max_kk, int block_size, const Mat& input_scales)
{
    ...
    if (input_scales.empty())
    {
        ...
        __m128i _vindex128 = _mm256_castsi256_si128(_vindex256);
#endif // __AVX2__
#endif // __AVX__
#endif // __SSE2__
        ...
        for (; ii < max_ii; ii++)
        {
            ...
            for (int g = 0; g < block_count; g++)
            {
                ...
                if (elempack == 1)
                {
                    ...
                    for (; kk + 15 < max_kk0; kk += 16)
                    {
                        __m512i _r = _mm512_i32gather_epi32(_vindex512, (const int*)p0a, sizeof(unsigned short));
                        __m512 _p = bfloat2float_avx512(_mm512_cvtepi32_epi16(_r));
                        _absmax512 = _mm512_max_ps(_absmax512, abs512_ps(_p));
                        p0a += A_hstep * 16;
                    }
                    ...
                    for (; kk + 7 < max_kk0; kk += 8)
                    {
                        __m256i _r = _mm256_i32gather_epi32((const int*)p0a, _vindex256, sizeof(unsigned short));
                        __m256 _p = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r));
                        _absmax256 = _mm256_max_ps(_absmax256, abs256_ps(_p));
                        p0a += A_hstep * 8;
                    }
                    ...
                    {
#if __AVX2__
                        __m128i _r = _mm_i32gather_epi32((const int*)p0a, _vindex128, sizeof(unsigned short));
                        __m128 _p = bfloat2float_sse(_mm_comp_cvtepi32_epi16(_r));
#else
                        __m128 _p = _mm_setr_ps(bfloat16_to_float32(p0a[0]), bfloat16_to_float32(p0a[A_hstep]), bfloat16_to_float32(p0a[A_hstep * 2]), bfloat16_to_float32(p0a[A_hstep * 3]));
#endif
                    ...
                    for (; kk + 15 < max_kk0; kk += 16)
                    {
                        __m512i _r = _mm512_i32gather_epi32(_vindex512, (const int*)p0, sizeof(unsigned short));
                        __m512 _p = bfloat2float_avx512(_mm512_cvtepi32_epi16(_r));
                        __m128i _q = float2int8_avx512(_mm512_mul_ps(_p, _scale512));
#if __AVX512VNNI__ || __AVXVNNI__
#if !__AVXVNNIINT8__
                    ...
                    {
#if __AVX2__
                        __m256i _r0 = _mm256_i32gather_epi32((const int*)p0, _vindex256, sizeof(unsigned short));
                        __m256i _r1 = _mm256_i32gather_epi32((const int*)(p0 + A_hstep * 8), _vindex256, sizeof(unsigned short));
                        __m256 _p0 = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r0));
                        __m256 _p1 = bfloat2float_avx(_mm256_comp_cvtepi32_epi16(_r1));
#else
                    ...
                    {
#if __AVX2__
                        __m128i _r = _mm_i32gather_epi32((const int*)p0, _vindex128, sizeof(unsigned short));
                        __m128 _p = bfloat2float_sse(_mm_comp_cvtepi32_epi16(_r));
#else
                        __m128 _p = _mm_setr_ps(bfloat16_to_float32(p0[0]), bfloat16_to_float32(p0[A_hstep]), bfloat16_to_float32(p0[A_hstep * 2]), bfloat16_to_float32(p0[A_hstep * 3]));
#endif
    ...
    for (; ii < max_ii; ii++)
    {
        ...
        for (int g = 0; g < block_count; g++)
        {
            ...
            if (elempack == 16)
            {
                ...
                for (int kk = 0; kk < max_kk0; kk += 16)
                {
                    __m512 _p = _mm512_mul_ps(bfloat2float_avx512(_mm256_loadu_si256((const __m256i*)p0)), _mm512_loadu_ps(ps));
                    __m128i _q = float2int8_avx512(_mm512_mul_ps(_p, _scale));
#if __AVX512VNNI__
                    _q = _mm_add_epi8(_q, _v127);
#endif // __AVX512VNNI__
