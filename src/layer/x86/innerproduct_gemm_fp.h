...
#endif
{
    ...
    {
        innerproduct_gemm_sse_fma(bottom_blob, top_blob, weight_data_tm, bias_data, activation_type, activation_params, opt);
        return;
    }
#endif
#if !NCNN_IMPL_FP16S && NCNN_RUNTIME_CPU && NCNN_FMA4 && __AVX__ && !__FMA__ && !__FMA4__
    ...
    {
        innerproduct_gemm_sse_fma4(bottom_blob, top_blob, weight_data_tm, bias_data, activation_type, activation_params, opt);
        return;
    }
#endif
