...
void selu_bf16s_avxneconvert(Mat& a, float alphaxlambda, float lambda, const Option& opt);
#endif
...
void selu_bf16s_fma4(Mat& a, float alphaxlambda, float lambda, const Option& opt);
#endif
...
static void selu_bf16s(Mat& a, float alphaxlambda, float lambda, const Option& opt)
{
    ...
    {
        selu_bf16s_avxneconvert(a, alphaxlambda, lambda, opt);
        return;
    }
#endif
    ...
    {
        selu_bf16s_fma(a, alphaxlambda, lambda, opt);
        return;
    }
#endif
#if NCNN_RUNTIME_CPU && NCNN_FMA4 && __AVX__ && !__FMA__ && !__FMA4__ && !__AVX512BF16__
    ...
    {
        selu_bf16s_fma4(a, alphaxlambda, lambda, opt);
        return;
    }
#endif
