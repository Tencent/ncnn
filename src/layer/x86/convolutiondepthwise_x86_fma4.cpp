...
void convdw5x5s1_pack4_sse_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
    convdw5x5s1_pack4_sse(bottom_blob, top_blob, kernel, bias, opt);
}

void convdw5x5s2_pack4_sse_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
    convdw5x5s2_pack4_sse(bottom_blob, top_blob, kernel, bias, opt);
}

void convdw3x3s1_pack8_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
    convdw3x3s1_pack8_avx(bottom_blob, top_blob, kernel, bias, opt);
}

void convdw3x3s2_pack8_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
    convdw3x3s2_pack8_avx(bottom_blob, top_blob, kernel, bias, opt);
}

void convdw5x5s1_pack8_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
    convdw5x5s1_pack8_avx(bottom_blob, top_blob, kernel, bias, opt);
}

void convdw5x5s2_pack8_avx_fma4(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& bias, const Option& opt)
{
