...
public:
    ...
    VkMat weight_data_gpu_tm_winograd23_int8_cm_low;
    VkMat weight_data_gpu_tm_winograd23_int8_cm_high;
    VkMat weight_data_gpu_tm_winograd43_int8_cm_low;
    VkMat weight_data_gpu_tm_winograd43_int8_cm_high;
    ...
    Mat weight_winograd23_data_int8_packed_cm_low;
    Mat weight_winograd23_data_int8_packed_cm_high;
    Mat weight_winograd43_data_int8_packed;
    Mat weight_winograd43_data_int8_packed_cm_low;
    Mat weight_winograd43_data_int8_packed_cm_high;
