...
int Interp_arm::forward_fp16sa(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
    ...
    if (dims == 2)
    {
        ...
        if (elempack == 8)
        {
            ...
            if (resize_type == 2) // bilinear
            {
                ...
                linear_coeffs_fp16sa_impl(w, outw, xofs, alpha, align_corner, get_resize_scale_x(w, outw));
            ...
            if (resize_type == 3) // bicubic
            {
                ...
                cubic_coeffs_fp16sa_impl(w, outw, xofs, alpha, align_corner, get_resize_scale_x(w, outw));
    ...
    if (elempack == 8)
    {
        ...
        if (resize_type == 2) // bilinear
        {
            ...
            linear_coeffs_fp16sa_impl(w, outw, xofs, alpha, align_corner, get_resize_scale_x(w, outw));
            linear_coeffs_fp16sa_impl(h, outh, yofs, beta, align_corner, get_resize_scale_y(h, outh));
        ...
        if (resize_type == 3) // bicubic
        {
            ...
            cubic_coeffs_fp16sa_impl(w, outw, xofs, alpha, align_corner, get_resize_scale_x(w, outw));
            cubic_coeffs_fp16sa_impl(h, outh, yofs, beta, align_corner, get_resize_scale_y(h, outh));
