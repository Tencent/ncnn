...
static void innerproduct_gemm_fp16sa(const Mat& bottom_blob, Mat& top_blob, const Mat& weight_data_tm, const Mat& bias_data, const Mat& bias_data_fp16, int num_input, int num_output, int bias_term, int activation_type, const Mat& activation_params, const Option& opt)
{
#if NCNN_RUNTIME_CPU && NCNN_ARM82 && __aarch64__ && !__ARM_FEATURE_FP16_VECTOR_ARITHMETIC
    if (ncnn::cpu_support_arm_asimdhp())
    {
        innerproduct_gemm_fp16sa_asimdhp(bottom_blob, top_blob, weight_data_tm, bias_data, bias_data_fp16, num_input, num_output, bias_term, activation_type, activation_params, opt);
        return;
    }
#endif
...
static void innerproduct_pack8_fp16sa(const Mat& bottom_blob, Mat& top_blob, const Mat& weight_data_tm, const Mat& bias_data_fp16, int num_input, int num_output, int bias_term, int activation_type, const Mat& activation_params, const Option& opt)
{
#if NCNN_RUNTIME_CPU && NCNN_ARM82 && __aarch64__ && !__ARM_FEATURE_FP16_VECTOR_ARITHMETIC
    if (ncnn::cpu_support_arm_asimdhp())
    {
        innerproduct_pack8_fp16sa_asimdhp(bottom_blob, top_blob, weight_data_tm, bias_data_fp16, num_input, num_output, bias_term, activation_type, activation_params, opt);
        return;
    }
#endif
...
static void innerproduct_pack4_fp16sa(const Mat& bottom_blob, Mat& top_blob, const Mat& weight_data_tm, const Mat& bias_data_fp16, int num_input, int num_output, int bias_term, int activation_type, const Mat& activation_params, const Option& opt)
{
#if NCNN_RUNTIME_CPU && NCNN_ARM82 && __aarch64__ && !__ARM_FEATURE_FP16_VECTOR_ARITHMETIC
    if (ncnn::cpu_support_arm_asimdhp())
    {
        innerproduct_pack4_fp16sa_asimdhp(bottom_blob, top_blob, weight_data_tm, bias_data_fp16, num_input, num_output, bias_term, activation_type, activation_params, opt);
        return;
    }
#endif
...
static void innerproduct_fp16sa(const Mat& bottom_blob, Mat& top_blob, const Mat& weight_data_tm, const Mat& bias_data, int num_input, int num_output, int bias_term, int activation_type, const Mat& activation_params, const Option& opt)
{
#if NCNN_RUNTIME_CPU && NCNN_ARM82 && __aarch64__ && !__ARM_FEATURE_FP16_VECTOR_ARITHMETIC
    if (ncnn::cpu_support_arm_asimdhp())
    {
        innerproduct_fp16sa_asimdhp(bottom_blob, top_blob, weight_data_tm, bias_data, num_input, num_output, bias_term, activation_type, activation_params, opt);
        return;
    }
#endif
