...
MAKE_FUNCTION(binary_op_rlogaddexp_fp16s, (__fp16)(std::max((float)y, (float)x) + log1pf(expf(std::min((float)y, (float)x) - std::max((float)y, (float)x)))), logaddexp_f16(y, x), logaddexpq_f16(y, x))
