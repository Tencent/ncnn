...
static void rnn_transform_kernel_fp16s(const Mat& weight_xc, const Mat& weight_hc, Mat& weight_xc_data_packed, Mat& weight_hc_data_packed, int size, int num_output, bool use_fp16_arithmetic)
{
