...
#include "matmul_mips.h"

#include "layer_type.h"

namespace ncnn {

MatMul_mips::MatMul_mips()
{
    gemm = 0;
}

int MatMul_mips::create_pipeline(const Option& opt)
{
...
int MatMul_mips::destroy_pipeline(const Option& opt)
{
    if (gemm)
    {
...
int MatMul_mips::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
