...
int Reshape_mips::forward_batch(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
    ...
    {
        if (ndim == 1)
            out_elempack = bottom_blob.elembits() == 16 && outw % 8 == 0 ? 8 : outw % 4 == 0 ? 4 : 1;
        if (ndim == 2)
            out_elempack = bottom_blob.elembits() == 16 && outh % 8 == 0 ? 8 : outh % 4 == 0 ? 4 : 1;
        if (ndim == 3 || ndim == 4)
            out_elempack = bottom_blob.elembits() == 16 && outc % 8 == 0 ? 8 : outc % 4 == 0 ? 4 : 1;
    }
#endif // __mips_msa
        ...
        if (batch_axis == 0 && elempack == 1 && out_elempack == 4 && scalar_elemsize == 4 && dims == 2 && ndim == 2 && bottom_blob.w == top_blob.w && top_blob.h * 4 == bottom_blob.h * bottom_blob.n)
        {
            ...
            for (int i = 0; i < top_blob.h; i++)
            {
                ...
                for (; j + 3 < bottom_blob.w; j += 4)
                {
                    ...
                    v4f32 _r0 = (v4f32)__msa_ld_w(ptr0, 0);
                    v4f32 _r1 = (v4f32)__msa_ld_w(ptr1, 0);
                    v4f32 _r2 = (v4f32)__msa_ld_w(ptr2, 0);
                    v4f32 _r3 = (v4f32)__msa_ld_w(ptr3, 0);
        ...
        if (batch_axis == 0 && elempack == 1 && out_elempack == 4 && scalar_elemsize == 4 && dims == 2 && ndim == 2 && bottom_blob.w == top_blob.w && bottom_blob.h == top_blob.h * batch * 4)
        {
            ...
            for (int bi = 0; bi < batch * top_blob.h; bi++)
            {
                ...
                for (; j + 3 < bottom_blob.w; j += 4)
                {
                    ...
                    __msa_st_w((v4i32)_r0123_0, outptr, 0);
                    __msa_st_w((v4i32)_r0123_1, outptr + 4, 0);
                    __msa_st_w((v4i32)_r0123_2, outptr + 8, 0);
                    __msa_st_w((v4i32)_r0123_3, outptr + 12, 0);
