            ...
            if (elempack == 1)
            {
                if (stride_w == 1)
                {
                    for (; kk + 3 < max_kk; kk += 4)
                    {
                        ...
                        v16i8 _r0 = (v16i8)__msa_loadl_d(sptr0);
                        v16i8 _r1 = (v16i8)__msa_loadl_d(sptr1);
                        v16i8 _r2 = (v16i8)__msa_loadl_d(sptr2);
                        v16i8 _r3 = (v16i8)__msa_loadl_d(sptr3);
                        transpose16x4_epi8(_r0, _r1, _r2, _r3);
                        __msa_st_b(_r0, pp, 0);
                        __msa_st_b(_r1, pp + 16, 0);
                        pp += 32;
            ...
            if (elempack == 1)
            {
                if (stride_w == 1)
                {
                    for (; kk + 3 < max_kk; kk += 4)
                    {
                        ...
                        v16i8 _r0 = (v16i8)__msa_fill_w_ptr(sptr0);
                        v16i8 _r1 = (v16i8)__msa_fill_w_ptr(sptr1);
                        v16i8 _r2 = (v16i8)__msa_fill_w_ptr(sptr2);
                        v16i8 _r3 = (v16i8)__msa_fill_w_ptr(sptr3);
                        transpose16x4_epi8(_r0, _r1, _r2, _r3);
                        __msa_st_b(_r0, pp, 0);
                        pp += 16;
                    }
...
static void convolution_im2col_input_tile_int8(const Mat& bottom_blob, Mat& B, int j, int max_jj, int k, int max_kk)
{
