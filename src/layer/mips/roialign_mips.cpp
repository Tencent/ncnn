...
#include "roialign_mips.h"

namespace ncnn {

ROIAlign_mips::ROIAlign_mips()
{
...
int ROIAlign_mips::forward(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
