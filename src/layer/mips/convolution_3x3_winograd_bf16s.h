            ...
            for (int m = 0; m < 4; m++)
            {
                ...
                if (ti * 2 + m < h)
                {
                    if (elempack == 4)
                    {
                        ...
                        if (tj * 2 + 1 < w) _r1 = bfloat2float_msa(r0 + 4);
                        if (tj * 2 + 2 < w) _r2 = bfloat2float_msa(r0 + 8);
                        if (tj * 2 + 3 < w) _r3 = bfloat2float_msa(r0 + 12);
                    }
                    if (elempack == 1)
                    {
    ...
    for (; ii + 3 < max_ii; ii += 4)
    {
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 2; m++)
            {
                ...
                if (out_elempack == 4)
                {
                    float2bfloat_msa_store(_tmp0, outptr0);
                    if (tj * 2 + 1 < outw) float2bfloat_msa_store(_tmp1, outptr0 + 4);
                }
                if (out_elempack == 1)
                {
                    float tmp0[4];
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 6; m++)
            {
                ...
                if (ti * 4 + m < h)
                {
                    ...
                    {
                        _r0 = bfloat2float_msa(r0);
                        if (tj * 4 + 1 < w) _r1 = bfloat2float_msa(r0 + 4);
                        if (tj * 4 + 2 < w) _r2 = bfloat2float_msa(r0 + 8);
                        if (tj * 4 + 3 < w) _r3 = bfloat2float_msa(r0 + 12);
                        if (tj * 4 + 4 < w) _r4 = bfloat2float_msa(r0 + 16);
                        if (tj * 4 + 5 < w) _r5 = bfloat2float_msa(r0 + 20);
                    }
                    if (elempack == 1)
                    {
                        const unsigned short* r1 = r0 + N;
    ...
    for (; ii + 3 < max_ii; ii += 4)
    {
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 4; m++)
            {
                ...
                {
                    float2bfloat_msa_store(_tmp0, outptr0);
                    if (tj * 4 + 1 < outw) float2bfloat_msa_store(_tmp1, outptr0 + 4);
                    if (tj * 4 + 2 < outw) float2bfloat_msa_store(_tmp2, outptr0 + 8);
                    if (tj * 4 + 3 < outw) float2bfloat_msa_store(_tmp3, outptr0 + 12);
                }
                if (out_elempack == 1)
                {
                    float tmp0[4];
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 8; m++)
            {
                ...
                if (ti * 6 + m < h)
                {
                    ...
                    {
                        _r0 = bfloat2float_msa(r0);
                        if (tj * 6 + 1 < w) _r1 = bfloat2float_msa(r0 + 4);
                        if (tj * 6 + 2 < w) _r2 = bfloat2float_msa(r0 + 8);
                        if (tj * 6 + 3 < w) _r3 = bfloat2float_msa(r0 + 12);
                        if (tj * 6 + 4 < w) _r4 = bfloat2float_msa(r0 + 16);
                        if (tj * 6 + 5 < w) _r5 = bfloat2float_msa(r0 + 20);
                        if (tj * 6 + 6 < w) _r6 = bfloat2float_msa(r0 + 24);
                        if (tj * 6 + 7 < w) _r7 = bfloat2float_msa(r0 + 28);
                    }
                    if (elempack == 1)
                    {
                        const unsigned short* r1 = r0 + N;
    ...
    for (int ppkk = 0; ppkk < nn_max_kk; ppkk++)
    {
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 8; m++)
            {
                ...
                float tmp34b0 = r10 * 0.5f - r30 * 2.5f + r50 * 2;
                float tmp34b1 = r11 * 0.5f - r31 * 2.5f + r51 * 2;
                float tmp56a0 = r60 + (r20 - r40 * 1.25f) * 4;
                float tmp56a1 = r61 + (r21 - r41 * 1.25f) * 4;
                float tmp56b0 = r10 * 2 - r30 * 2.5f + r50 * 0.5f;
                float tmp56b1 = r11 * 2 - r31 * 2.5f + r51 * 0.5f;
    ...
    for (int kk = remain_max_kk_start; kk < max_kk; kk++)
    {
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 8; m++)
            {
                ...
                float tmp34b = r1 * 0.5f - r3 * 2.5f + r5 * 2;
                float tmp56a = r6 + (r2 - r4 * 1.25f) * 4;
                float tmp56b = r1 * 2 - r3 * 2.5f + r5 * 0.5f;
    ...
    for (; ii + 3 < max_ii; ii += 4)
    {
        ...
        for (; jj < max_jj; jj++)
        {
            ...
            for (int m = 0; m < 6; m++)
            {
                ...
                {
                    float2bfloat_msa_store(_tmp0, outptr0);
                    if (tj * 6 + 1 < outw) float2bfloat_msa_store(_tmp1, outptr0 + 4);
                    if (tj * 6 + 2 < outw) float2bfloat_msa_store(_tmp2, outptr0 + 8);
                    if (tj * 6 + 3 < outw) float2bfloat_msa_store(_tmp3, outptr0 + 12);
                    if (tj * 6 + 4 < outw) float2bfloat_msa_store(_tmp4, outptr0 + 16);
                    if (tj * 6 + 5 < outw) float2bfloat_msa_store(_tmp5, outptr0 + 20);
                }
                if (out_elempack == 1)
                {
                    float tmp0[4];
