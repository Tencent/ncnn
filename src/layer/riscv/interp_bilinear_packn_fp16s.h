    ...
    for (int dy = 0; dy < h; dy++)
    {
        ...
        else if (sy == prev_sy1 + 1)
        {
            ...
            for (; dx < w; dx++)
            {
                ...
                vfloat32m2_t _rows1 = __riscv_vfwmacc_vf_f32m2(__riscv_vfwmul_vf_f32m2(_S10, (__fp16)alphap[0], vl), alphap[1], _S11, vl);
        ...
        else
        {
            ...
            for (; dx < w; dx++)
            {
                ...
                vfloat16m1_t _S10 = __riscv_vle16_v_f16m1(S1p, vl);
                vfloat16m1_t _S11 = __riscv_vle16_v_f16m1(S1p + packn, vl);
                vfloat32m2_t _rows0 = __riscv_vfwmacc_vf_f32m2(__riscv_vfwmul_vf_f32m2(_S00, (__fp16)alphap[0], vl), alphap[1], _S01, vl);
                vfloat32m2_t _rows1 = __riscv_vfwmacc_vf_f32m2(__riscv_vfwmul_vf_f32m2(_S10, (__fp16)alphap[0], vl), alphap[1], _S11, vl);
