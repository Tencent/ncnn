...
#define _RVV_FLOAT32_ERF_OP(LMUL, MLEN)                                                                                                                                                                                                           \
    ...
    {                                                                                                                                                                                                                                             \
        ...
        r_large = __riscv_vfmadd_vvf_f32m##LMUL(t, c_erf_c0, c_erf_c1, vl);                                                                                                                                                                       \
        vfloat32m##LMUL##_t u = __riscv_vfmadd_vvf_f32m##LMUL(t, c_erf_c2, c_erf_c3, vl);                                                                                                                                                         \
        r_large = __riscv_vfmadd_vv_f32m##LMUL(r_large, s, u, vl);                                                                                                                                                                                \
        r_large = __riscv_vfmadd_vv_f32m##LMUL(r_large, t, c_erf_c4, vl);                                                                                                                                                                         \
        r_large = __riscv_vfmadd_vv_f32m##LMUL(r_large, t, c_erf_c5, vl);                                                                                                                                                                         \
        r_large = __riscv_vfmadd_vv_f32m##LMUL(r_large, t, c_erf_c6, vl);                                                                                                                                                                         \
        ...
        r_small = __riscv_vfmadd_vv_f32m##LMUL(r_small, s, c_erf_s1, vl);                                                                                                                                                                         \
        r_small = __riscv_vfmadd_vv_f32m##LMUL(r_small, s, c_erf_s2, vl);                                                                                                                                                                         \
        r_small = __riscv_vfmadd_vv_f32m##LMUL(r_small, s, c_erf_s3, vl);                                                                                                                                                                         \
        r_small = __riscv_vfmadd_vv_f32m##LMUL(r_small, s, c_erf_s4, vl);                                                                                                                                                                         \
        r_small = __riscv_vfmadd_vv_f32m##LMUL(r_small, s, c_erf_s5, vl);                                                                                                                                                                         \
