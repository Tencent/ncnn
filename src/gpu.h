...
#define NCNN_SIMPLEVK_DEBUG_PRINTF (ENABLE_VALIDATION_LAYER && NCNN_SIMPLEVK)
...
public:
    ...
    int create_pipeline_layout(int push_constant_count, VkDescriptorSetLayout descriptorset_layout, const ShaderInfo& shader_info, VkPipelineLayout* pipeline_layout) const;
    ...
    VkDescriptorSetLayout simplevk_printf_descriptorset_layout() const;
