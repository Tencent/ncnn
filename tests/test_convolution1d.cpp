...
static int test_convolution1d_load_param()
{
    ...
    int ret = 0
              ...
              || test_convolution1d_load_param_activation(base, 0, ncnn::Mat(0), true)
              ...
              || test_convolution1d_load_param_activation(base, 1, ncnn::Mat(0), true)
              ...
              || test_convolution1d_load_param_activation(base, 2, ncnn::Mat(0), false)
              ...
              || test_convolution1d_load_param_activation(base, 3, ncnn::Mat(0), false)
              ...
              || test_convolution1d_load_param_activation(base, 4, ncnn::Mat(0), true)
              ...
              || test_convolution1d_load_param_activation(base, 5, ncnn::Mat(0), true)
              ...
              || test_convolution1d_load_param_activation(base, 6, ncnn::Mat(0), false)
