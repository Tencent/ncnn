...
static int test_quantize(ncnn::Mat a, float scale_low, float scale_high)
{
    ...
    else
    {
        ...
        if (a.dims == 4) scale_data.create(a.c);
...
static int test_quantize_3()
{
    return 0
           || test_quantize(RandomMat(5, 3, 2, 24), 100.f, 100.f)
           || test_quantize(RandomMat(5, 3, 2, 24), 120.f, 140.f)
           || test_quantize(RandomMat(3, 5, 3, 13), 100.f, 100.f)
           || test_quantize(RandomMat(3, 5, 3, 13), 120.f, 140.f);
}
