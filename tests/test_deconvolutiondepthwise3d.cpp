...
static int test_deconvolutiondepthwise3d_activation_params_text()
{
#if NCNN_STRING
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (ret != 0)
        {
            fprintf(stderr, "test_deconvolutiondepthwise3d_activation_params_text failed params=%s ret=%d\n", params[i], ret);
            return ret;
        }
        ...
        {
            fprintf(stderr, "test_deconvolutiondepthwise3d_activation_params_text modified params=%s\n", params[i]);
            return -1;
        }
    }
#endif
...
int main()
{
    ...
    return 0
           || test_deconvolutiondepthwise3d_0()
           || test_deconvolutiondepthwise3d_activation_params_text()
#if NCNN_VALIDATION
           || test_deconvolutiondepthwise3d_load_param()
           || test_deconvolutiondepthwise3d_load_param_text()
#endif // NCNN_VALIDATION
           ;
}
