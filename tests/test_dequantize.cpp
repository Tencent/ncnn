...
static int test_dequantize(const ncnn::Mat& a, int scale_data_size, int bias_data_size)
{
    ...
    if (ret != 0)
    {
        fprintf(stderr, "test_dequantize failed a.dims=%d a=(%d %d %d %d) scale_data_size=%d bias_data_size=%d\n", a.dims, a.w, a.h, a.d, a.c, scale_data_size, bias_data_size);
    }
...
static int test_dequantize_pack8(const ncnn::Mat& a, int scale_data_size, int bias_data_size)
{
    ...
    if (ret != 0)
    {
        fprintf(stderr, "test_dequantize_pack8 failed a.dims=%d a=(%d %d %d %d) scale_data_size=%d bias_data_size=%d\n", a.dims, a.w, a.h, a.d, a.c, scale_data_size, bias_data_size);
    }
...
static int test_dequantize_4()
{
    return 0
           || test_dequantize(RandomIntMat(5, 3, 2, 24), 1, 24)
           || test_dequantize(RandomIntMat(5, 3, 2, 24), 1, 1)
           || test_dequantize(RandomIntMat(5, 3, 2, 24), 1, 0)
           || test_dequantize(RandomIntMat(5, 3, 2, 24), 24, 24)
           || test_dequantize(RandomIntMat(5, 3, 2, 24), 24, 1)
           || test_dequantize(RandomIntMat(5, 3, 2, 24), 24, 0)
           || test_dequantize(RandomIntMat(3, 5, 3, 13), 1, 13)
           || test_dequantize(RandomIntMat(3, 5, 3, 13), 13, 13)
           || test_dequantize(RandomIntMat(3, 5, 3, 13), 13, 0)
           || test_dequantize_pack8(RandomIntMat(5, 3, 2, 24), 1, 24)
           || test_dequantize_pack8(RandomIntMat(5, 3, 2, 24), 24, 24);
}
