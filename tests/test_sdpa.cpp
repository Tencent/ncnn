...
static int test_sdpa_0()
{
    return 0
           ...
           || test_sdpa(RandomMat(64, 128, 2), RandomMat(64, 128, 2), RandomMat(64, 128, 2), 0)
           || test_sdpa(RandomMat(48, 122, 2), RandomMat(64, 127, 2), RandomMat(64, 127, 2), 1)
           ...
           || test_sdpa(RandomMat(28, 17, 5), RandomMat(28, 127, 5), RandomMat(32, 127, 5), 0, 0.1f)
           || test_sdpa(RandomMat(28, 17, 5), RandomMat(28, 32, 5), RandomMat(11, 32, 5), 1, -0.4f);
}
