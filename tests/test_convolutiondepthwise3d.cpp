...
static int test_convolutiondepthwise3d_load_param_case(const ncnn::ParamDict& pd, bool valid)
{
    ncnn::Layer* layer = ncnn::create_layer_naive(ncnn::LayerType::ConvolutionDepthWise3D);
    if (!layer)
        return -1;
...
static int test_convolutiondepthwise3d_load_param()
{
    ...
    int ret = 0
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 0, ncnn::Mat(0), true)
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 1, ncnn::Mat(0), true)
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 2, ncnn::Mat(0), false)
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 3, ncnn::Mat(0), false)
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 4, ncnn::Mat(0), true)
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 5, ncnn::Mat(0), true)
              ...
              || test_convolutiondepthwise3d_load_param_activation(base, 6, ncnn::Mat(0), false)
